...
/// Get a secret for the authenticated user
    ...
    public func getSecretForAuthenticatedUser(secretName: String) async throws -> CodespacesSecret {
        return try await CodespacesMethods.codespacesGetSecretForAuthenticatedUser(config: config, secretName: secretName)
    }
...
/// Create or update a secret for the authenticated user
    ...
    public func createOrUpdateSecretForAuthenticatedUser(secretName: String, keyId: String, encryptedValue: String?, selectedRepositoryIds: [CodespacesCreateOrUpdateSecretForAuthenticatedUserRequestBodyX84658888db]?) async throws -> EmptyObject {
        return try await CodespacesMethods.codespacesCreateOrUpdateSecretForAuthenticatedUser(config: config, secretName: secretName, keyId: keyId, encryptedValue: encryptedValue, selectedRepositoryIds: selectedRepositoryIds)
    }
...
/// Delete a secret for the authenticated user
    ...
    public func deleteSecretForAuthenticatedUser(secretName: String) async throws -> SdkEmptyResponse {
        return try await CodespacesMethods.codespacesDeleteSecretForAuthenticatedUser(config: config, secretName: secretName)
    }
...
/// List selected repositories for a user secret
    ...
    public func listRepositoriesForSecretForAuthenticatedUser(secretName: String) async throws -> CodespacesListRepositoriesForSecretForAuthenticatedUserResponse {
        return try await CodespacesMethods.codespacesListRepositoriesForSecretForAuthenticatedUser(config: config, secretName: secretName)
    }
...
/// Set selected repositories for a user secret
    ...
    public func setRepositoriesForSecretForAuthenticatedUser(secretName: String, selectedRepositoryIds: [Int]) async throws -> SdkEmptyResponse {
        return try await CodespacesMethods.codespacesSetRepositoriesForSecretForAuthenticatedUser(config: config, secretName: secretName, selectedRepositoryIds: selectedRepositoryIds)
    }
...
/// Add a selected repository to a user secret
    ...
    public func addRepositoryForSecretForAuthenticatedUser(secretName: String, repositoryId: Int) async throws -> SdkEmptyResponse {
        return try await CodespacesMethods.codespacesAddRepositoryForSecretForAuthenticatedUser(config: config, secretName: secretName, repositoryId: repositoryId)
    }
...
/// Remove a selected repository from a user secret
    ...
    public func removeRepositoryForSecretForAuthenticatedUser(secretName: String, repositoryId: Int) async throws -> SdkEmptyResponse {
        return try await CodespacesMethods.codespacesRemoveRepositoryForSecretForAuthenticatedUser(config: config, secretName: secretName, repositoryId: repositoryId)
    }
...
/// Get a codespace for the authenticated user
    ...
    public func getForAuthenticatedUser(codespaceName: String) async throws -> Codespace {
        return try await CodespacesMethods.codespacesGetForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
}
...
/// Update a codespace for the authenticated user
    ...
    public func updateForAuthenticatedUser(codespaceName: String, machine: String?, displayName: String?, recentFolders: [String]?) async throws -> Codespace {
        return try await CodespacesMethods.codespacesUpdateForAuthenticatedUser(config: config, codespaceName: codespaceName, machine: machine, displayName: displayName, recentFolders: recentFolders)
    }
...
/// Delete a codespace for the authenticated user
    ...
    public func deleteForAuthenticatedUser(codespaceName: String) async throws -> [String: JSONValue] {
        return try await CodespacesMethods.codespacesDeleteForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
...
/// Export a codespace for the authenticated user
    ...
    public func exportForAuthenticatedUser(codespaceName: String) async throws -> CodespaceExportDetails {
        return try await CodespacesMethods.codespacesExportForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
...
/// Get details about a codespace export
    ...
    public func getExportDetailsForAuthenticatedUser(codespaceName: String, exportId: String) async throws -> CodespaceExportDetails {
        return try await CodespacesMethods.codespacesGetExportDetailsForAuthenticatedUser(config: config, codespaceName: codespaceName, exportId: exportId)
    }
...
/// List machine types for a codespace
    ...
    public func codespaceMachinesForAuthenticatedUser(codespaceName: String) async throws -> CodespacesCodespaceMachinesForAuthenticatedUserResponse {
        return try await CodespacesMethods.codespacesCodespaceMachinesForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
...
/// Create a repository from an unpublished codespace
    ...
    public func publishForAuthenticatedUser(codespaceName: String, name: String?, private: Bool?) async throws -> CodespaceWithFullRepository {
        return try await CodespacesMethods.codespacesPublishForAuthenticatedUser(config: config, codespaceName: codespaceName, name: name, private: `private`)
    }
...
/// Start a codespace for the authenticated user
    ...
    public func startForAuthenticatedUser(codespaceName: String) async throws -> Codespace {
        return try await CodespacesMethods.codespacesStartForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
...
/// Stop a codespace for the authenticated user
    ...
    public func stopForAuthenticatedUser(codespaceName: String) async throws -> Codespace {
        return try await CodespacesMethods.codespacesStopForAuthenticatedUser(config: config, codespaceName: codespaceName)
    }
}
...
/// Lists Copilot Spaces owned by an organization. The authenticated user must have read access to the organization's Copilot Spaces. Only Spaces that are readable by the authenticated user are returned. This includes public Spaces and internal Spaces if the user is a member of the organization. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in a space; spaces with inaccessible resources are omitted from the response.
    public func listForOrg(org: String, perPage: Int?, before: String?, after: String?) async throws -> CopilotSpacesListForOrgResponse {
        return try await CopilotSpacesMethods.copilotSpacesListForOrg(config: config, org: org, perPage: perPage, before: before, after: after)
    }
...
/// Creates a new Copilot Space owned by an organization. The authenticated user must have permissions to create spaces in the organization. Organization members with appropriate permissions can create Copilot Spaces to be shared within their organization. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by the submitted resources.
    public func createForOrg(org: String, name: String, description: String?, generalInstructions: String?, baseRole: CopilotSpacesCreateForOrgRequestBodyBaseRole?, resourcesAttributes: [CopilotSpacesCreateForOrgRequestBodyResourcesAttributesItem]?) async throws -> CopilotSpace {
        return try await CopilotSpacesMethods.copilotSpacesCreateForOrg(config: config, org: org, name: name, description: description, generalInstructions: generalInstructions, baseRole: baseRole, resourcesAttributes: resourcesAttributes)
    }
...
/// Gets details about a specific Copilot Space owned by an organization. The authenticated user must have read access to the Space. Internal Spaces require the authenticated user to be a member of the organization or have been granted read permissions. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func getForOrg(org: String, spaceNumber: Int) async throws -> CopilotSpace {
        return try await CopilotSpacesMethods.copilotSpacesGetForOrg(config: config, org: org, spaceNumber: spaceNumber)
    }
...
/// Updates a Copilot Space owned by an organization. The authenticated user must have permissions to update spaces in the organization. Organization members with appropriate permissions can update Copilot Spaces owned by their organization. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space, including any being added or updated.
    public func updateForOrg(org: String, spaceNumber: Int, name: String?, description: String?, generalInstructions: String?, baseRole: CopilotSpacesUpdateForOrgRequestBodyBaseRole?, resourcesAttributes: [CopilotSpacesUpdateForOrgRequestBodyResourcesAttributesItem]?) async throws -> CopilotSpace {
        return try await CopilotSpacesMethods.copilotSpacesUpdateForOrg(config: config, org: org, spaceNumber: spaceNumber, name: name, description: description, generalInstructions: generalInstructions, baseRole: baseRole, resourcesAttributes: resourcesAttributes)
    }
...
/// Deletes a Copilot Space owned by an organization. The authenticated user must have permissions to delete spaces in the organization. **Warning:** This action is permanent and cannot be undone. Deleting a Copilot Space will remove all associated resources and configurations. Organization members with appropriate permissions can delete Copilot Spaces owned by their organization. OAuth app tokens and personal access tokens (classic) need both the `read:org` and `repo` scopes to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func deleteForOrg(org: String, spaceNumber: Int) async throws -> SdkEmptyResponse {
        return try await CopilotSpacesMethods.copilotSpacesDeleteForOrg(config: config, org: org, spaceNumber: spaceNumber)
    }
...
/// Lists all collaborators for a specific Copilot Space owned by an organization. The authenticated user must have appropriate permissions to view collaborators. Each collaborator entry specifies which user or team has access to the space and at what level (reader, writer, or admin). The space owner (organization) is excluded from this list. **Note:** Team collaborators listed here are teams that are defined in the organization. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func listCollaboratorsForOrg(org: String, spaceNumber: Int) async throws -> CopilotSpacesListCollaboratorsForOrgResponse {
        return try await CopilotSpacesMethods.copilotSpacesListCollaboratorsForOrg(config: config, org: org, spaceNumber: spaceNumber)
    }
...
/// Adds a collaborator (user or team) to a specific Copilot Space owned by an organization. The authenticated user must have appropriate permissions to manage collaborators. **Note:** When adding users as collaborators, they must already be members of the organization. When adding teams as collaborators, they must be defined in the organization. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func addCollaboratorForOrg(org: String, spaceNumber: Int, actorType: CopilotSpacesAddCollaboratorForOrgRequestBodyActorType, actorIdentifier: String, role: CopilotSpacesAddCollaboratorForOrgRequestBodyRole) async throws -> CopilotSpaceCollaborator {
        return try await CopilotSpacesMethods.copilotSpacesAddCollaboratorForOrg(config: config, org: org, spaceNumber: spaceNumber, actorType: actorType, actorIdentifier: actorIdentifier, role: role)
    }
...
/// Updates the role of a collaborator for a specific Copilot Space owned by an organization. The authenticated user must have appropriate permissions to manage collaborators. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func updateCollaboratorForOrg(org: String, spaceNumber: Int, actorType: CopilotSpacesUpdateCollaboratorForOrgParameter, actorIdentifier: String, role: CopilotSpacesUpdateCollaboratorForOrgRequestBodyRole) async throws -> CopilotSpaceCollaborator {
        return try await CopilotSpacesMethods.copilotSpacesUpdateCollaboratorForOrg(config: config, org: org, spaceNumber: spaceNumber, actorType: actorType, actorIdentifier: actorIdentifier, role: role)
    }
}

extension CopilotSpacesNamespace {
/// Removes a collaborator from a specific Copilot Space owned by an organization. The authenticated user must have appropriate permissions to manage collaborators. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func removeCollaboratorForOrg(org: String, spaceNumber: Int, actorType: CopilotSpacesRemoveCollaboratorForOrgParameter, actorIdentifier: String) async throws -> SdkEmptyResponse {
        return try await CopilotSpacesMethods.copilotSpacesRemoveCollaboratorForOrg(config: config, org: org, spaceNumber: spaceNumber, actorType: actorType, actorIdentifier: actorIdentifier)
    }
...
/// Lists all resources attached to a specific Copilot Space owned by an organization. The authenticated user must have appropriate permissions to view the space. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func listResourcesForOrg(org: String, spaceNumber: Int) async throws -> CopilotSpacesListResourcesForOrgResponse {
        return try await CopilotSpacesMethods.copilotSpacesListResourcesForOrg(config: config, org: org, spaceNumber: spaceNumber)
    }
...
/// Creates a new resource in a specific Copilot Space owned by an organization. The authenticated user must have write permissions on the space. The following resource types are supported: `repository`, `github_file`, `free_text`, `github_issue`, `github_pull_request`. The `uploaded_text_file` and `media_content` types are not supported via this endpoint. For `github_file` resources, if a resource with the same repository, file path, and SHA already exists, the existing resource is returned with a `200` status. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space, including the resource being created.
    public func createResourceForOrg(org: String, spaceNumber: Int, resourceType: CopilotSpacesCreateResourceForOrgRequestBodyResourceType, metadata: [String: JSONValue]) async throws -> CopilotSpaceResource {
        return try await CopilotSpacesMethods.copilotSpacesCreateResourceForOrg(config: config, org: org, spaceNumber: spaceNumber, resourceType: resourceType, metadata: metadata)
    }

/// Gets a specific resource attached to a Copilot Space owned by an organization. The authenticated user must have appropriate permissions to view the space. OAuth app tokens and personal access tokens (classic) need the `read:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func getResourceForOrg(org: String, spaceNumber: Int, spaceResourceId: Int) async throws -> CopilotSpaceResource {
        return try await CopilotSpacesMethods.copilotSpacesGetResourceForOrg(config: config, org: org, spaceNumber: spaceNumber, spaceResourceId: spaceResourceId)
    }
...
/// Updates the metadata of a resource in a specific Copilot Space owned by an organization. The authenticated user must have write permissions on the space. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space, including the resource being updated.
    public func updateResourceForOrg(org: String, spaceNumber: Int, spaceResourceId: Int, metadata: [String: JSONValue]?) async throws -> CopilotSpaceResource {
        return try await CopilotSpacesMethods.copilotSpacesUpdateResourceForOrg(config: config, org: org, spaceNumber: spaceNumber, spaceResourceId: spaceResourceId, metadata: metadata)
    }

/// Deletes a resource from a specific Copilot Space owned by an organization. The authenticated user must have write permissions on the space. OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint. Fine-grained tokens and GitHub App user access tokens must have been granted access to the organization that owns the space. They must also have been granted access to every repository referenced by resources in the space.
    public func deleteResourceForOrg(org: String, spaceNumber: Int, spaceResourceId: Int) async throws -> SdkEmptyResponse {
        return try await CopilotSpacesMethods.copilotSpacesDeleteResourceForOrg(config: config, org: org, spaceNumber: spaceNumber, spaceResourceId: spaceResourceId)
    }
...
/// List Copilot Spaces for a user
    ...
    public func listForUser(username: String, perPage: Int?, before: String?, after: String?) async throws -> CopilotSpacesListForUserResponse {
        return try await CopilotSpacesMethods.copilotSpacesListForUser(config: config, username: username, perPage: perPage, before: before, after: after)
    }
...
/// Create a Copilot Space for a user
    ...
    public func createForUser(username: String, name: String, description: String?, generalInstructions: String?, baseRole: CopilotSpacesCreateForUserRequestBodyBaseRole?, resourcesAttributes: [CopilotSpacesCreateForUserRequestBodyResourcesAttributesItem]?) async throws -> CopilotSpace {
        return try await CopilotSpacesMethods.copilotSpacesCreateForUser(config: config, username: username, name: name, description: description, generalInstructions: generalInstructions, baseRole: baseRole, resourcesAttributes: resourcesAttributes)
    }
}
