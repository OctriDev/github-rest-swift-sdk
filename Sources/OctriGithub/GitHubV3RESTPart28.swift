...
public extension ReposNamespace {
    ...
    /// documentation.
    func deletePullRequestReviewProtection(
        owner: String,
        repo: String,
        branch: String
    ) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposDeletePullRequestReviewProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    func getCommitSignatureProtection(
        owner: String,
        repo: String,
        branch: String
    ) async throws -> ProtectedBranchAdminEnforced {
        try await ReposMethods.reposGetCommitSignatureProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. When authenticated with admin or owner permissions to the repository, you can use this endpoint
    /// to require signed commits on a branch. You must enable branch protection to require signed commits.
    func createCommitSignatureProtection(
        owner: String,
        repo: String,
        branch: String
    ) async throws -> ProtectedBranchAdminEnforced {
        try await ReposMethods.reposCreateCommitSignatureProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. When authenticated with admin or owner permissions to the repository, you can use this endpoint
    /// to disable required signed commits on a branch. You must enable branch protection to require signed commits.
    func deleteCommitSignatureProtection(owner: String, repo: String, branch: String) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposDeleteCommitSignatureProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func getStatusChecksProtection(owner: String, repo: String, branch: String) async throws -> StatusCheckPolicy {
        try await ReposMethods.reposGetStatusChecksProtection(config: config, owner: owner, repo: repo, branch: branch)
    }
    ...
    func updateStatusCheckProtection(
        owner: String,
        repo: String,
        branch: String,
        strict: Bool?,
        ...
        try await ReposMethods.reposUpdateStatusCheckProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func removeStatusCheckProtection(owner: String, repo: String, branch: String) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposRemoveStatusCheckProtection(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func getAllStatusCheckContexts(owner: String, repo: String, branch: String) async throws -> [String] {
        try await ReposMethods.reposGetAllStatusCheckContexts(config: config, owner: owner, repo: repo, branch: branch)
    }
}

public extension ReposNamespace {
    /// Adds status check contexts to the required status checks for a protected repository branch. Provide `contexts`
    /// as either an object property or a JSON array of status check names, and use a branch name without wildcard
    /// characters. The response contains the configured status check contexts.
    ///
    /// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and
    /// in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func addStatusCheckContexts(
        owner: String,
        repo: String,
        branch: String,
        body: ReposAddStatusCheckContextsRequestBody?
    ) async throws -> [String] {
        try await ReposMethods.reposAddStatusCheckContexts(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func setStatusCheckContexts(
        owner: String,
        repo: String,
        branch: String,
        body: ReposSetStatusCheckContextsRequestBody?
    ) async throws -> [String] {
        try await ReposMethods.reposSetStatusCheckContexts(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// Removes status check contexts from the required status checks for a protected repository branch. Provide
    /// `contexts` as either an object property or a JSON array of status check names, and use a branch name without
    /// wildcard characters. The response contains the remaining configured status check contexts.
    ///
    /// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and
    /// in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation.
    func removeStatusCheckContexts(
        owner: String,
        repo: String,
        branch: String,
        body: ReposRemoveStatusCheckContextsRequestBody?
    ) async throws -> [String] {
        try await ReposMethods.reposRemoveStatusCheckContexts(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    func getAccessRestrictions(owner: String, repo: String, branch: String) async throws -> BranchRestrictionPolicy {
        try await ReposMethods.reposGetAccessRestrictions(config: config, owner: owner, repo: repo, branch: branch)
    }
    ...
    func deleteAccessRestrictions(owner: String, repo: String, branch: String) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposDeleteAccessRestrictions(config: config, owner: owner, repo: repo, branch: branch)
    }
    ...
    func getAppsWithAccessToProtectedBranch(
        owner: String,
        repo: String,
        branch: String
    ) async throws -> [Integration?] {
        try await ReposMethods.reposGetAppsWithAccessToProtectedBranch(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    func addAppAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        apps: [String]
    ) async throws -> [Integration?] {
        try await ReposMethods.reposAddAppAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. Replaces the list of apps that have push access to this branch. This removes all apps that
    /// previously had push access and grants push access to the new list of apps. Only GitHub Apps that are installed
    /// on the repository and that have been granted write access to the repository contents can be added as authorized
    /// actors on a protected branch.
    func setAppAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        apps: [String]
    ) async throws -> [Integration?] {
        try await ReposMethods.reposSetAppAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
...
public extension ReposNamespace {
    ...
    /// repository and that have been granted write access to the repository contents can be added as authorized actors
    /// on a protected branch.
    func removeAppAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        apps: [String]
    ) async throws -> [Integration?] {
        try await ReposMethods.reposRemoveAppAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. Lists the teams who have push access to this branch. The list includes child teams.
    func getTeamsWithAccessToProtectedBranch(owner: String, repo: String, branch: String) async throws -> [Team] {
        try await ReposMethods.reposGetTeamsWithAccessToProtectedBranch(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    /// Grants the specified teams push access to a protected branch. Provide team slugs in `teams` and identify the
    /// repository with `owner`, `repo`, and `branch`; child teams also receive access. The response lists the teams
    /// with access after the restriction is applied.
    ///
    /// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and
    /// in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. Grants the specified teams push access for this branch. You can also give push access to child
    /// teams.
    func addTeamAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        body: ReposAddTeamAccessRestrictionsRequestBody?
    ) async throws -> [Team] {
        try await ReposMethods.reposAddTeamAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// teams.
    func setTeamAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        body: ReposSetTeamAccessRestrictionsRequestBody?
    ) async throws -> [Team] {
        try await ReposMethods.reposSetTeamAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// teams.
    func removeTeamAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        body: ReposRemoveTeamAccessRestrictionsRequestBody?
    ) async throws -> [Team] {
        try await ReposMethods.reposRemoveTeamAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// Server. For more information, see [GitHub's
    /// products](https://docs.github.com/github/getting-started-with-github/githubs-products) in the GitHub Help
    /// documentation. Lists the people who have push access to this branch.
    func getUsersWithAccessToProtectedBranch(owner: String, repo: String, branch: String) async throws -> [SimpleUser] {
        try await ReposMethods.reposGetUsersWithAccessToProtectedBranch(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch
    ...
    func addUserAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        users: [String]
    ) async throws -> [SimpleUser] {
        try await ReposMethods.reposAddUserAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    /// | | `array` | Usernames for people who can have push access. **Note**: The list of users, apps, and teams in
    /// total is limited to 100 items. |
    func setUserAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        users: [String]
    ) async throws -> [SimpleUser] {
        try await ReposMethods.reposSetUserAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
...
public extension ReposNamespace {
    ...
    func removeUserAccessRestrictions(
        owner: String,
        repo: String,
        branch: String,
        users: [String]
    ) async throws -> [SimpleUser] {
        try await ReposMethods.reposRemoveUserAccessRestrictions(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    func renameBranch(
        ...
        try await ReposMethods.reposRenameBranch(
            config: config,
            owner: owner,
            repo: repo,
            branch: branch,
    ...
    func codeownersErrors(owner: String, repo: String, ref: String?) async throws -> CodeownersErrors {
        try await ReposMethods.reposCodeownersErrors(config: config, owner: owner, repo: repo, ref: ref)
    }
    ...
    func listCollaborators(
        ...
        try await ReposMethods.reposListCollaborators(
            config: config,
            owner: owner,
            repo: repo,
    ...
    /// For organization-owned repositories, the list of collaborators includes outside collaborators, organization
    /// members that are direct collaborators, organization members with access through team memberships, organization
    /// members with access through default organization permissions, and organization owners. Team members will include
    /// the members of child teams. The authenticated user must have push access to the repository to use this endpoint.
    /// OAuth app tokens and personal access tokens (classic) need the `read:org` and `repo` scopes to use this
    /// endpoint.
    func checkCollaborator(owner: String, repo: String, username: String) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposCheckCollaborator(config: config, owner: owner, repo: repo, username: username)
    }
    ...
    func addCollaborator(
        ...
        try await ReposMethods.reposAddCollaborator(
            config: config,
            owner: owner,
            repo: repo,
            username: username,
    ...
    func removeCollaborator(owner: String, repo: String, username: String) async throws -> SdkEmptyResponse {
        try await ReposMethods.reposRemoveCollaborator(config: config, owner: owner, repo: repo, username: username)
    }
    ...
    func getCollaboratorPermissionLevel(
        owner: String,
        repo: String,
        username: String
    ) async throws -> RepositoryCollaboratorPermission {
        try await ReposMethods.reposGetCollaboratorPermissionLevel(
            config: config,
            owner: owner,
            repo: repo,
            username: username
