...
public extension PackagesNamespace {
    ...
    func deletePackageVersionForAuthenticatedUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        packageVersionId: Int
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesDeletePackageVersionForAuthenticatedUser(
            config: config,
    ...
    func restorePackageVersionForAuthenticatedUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        packageVersionId: Int
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesRestorePackageVersionForAuthenticatedUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            packageVersionId: packageVersionId
    ...
    func packagesListDockerMigrationConflictingForUser(username: String) async throws -> [Package] {
        try await PackagesMethods.packagesListDockerMigrationConflictingPackagesForUser(
            config: config,
            username: username
        )
    }
    ...
    func packagesListForUser(
        ...
        try await PackagesMethods.packagesListPackagesForUser(
            config: config,
            username: username,
            packageType: packageType,
    ...
    /// permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func getPackageForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String
    ) async throws -> Package {
        try await PackagesMethods.packagesGetPackageForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username
    ...
    /// than 5,000 downloads. In this scenario, contact GitHub support for further assistance. If the `package_type`
    /// belongs to a GitHub Packages registry that supports granular permissions, the authenticated user must have admin
    /// permissions to the package. For the list of these registries, see "[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages)."
    ...
    func deletePackageForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesDeletePackageForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username
    ...
    /// use this endpoint. For more information, see "[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func restorePackageForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String,
        token: String?
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesRestorePackageForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username,
    ...
    ///
    /// Lists package versions for a public package owned by a specified user. OAuth app tokens and personal access
    /// tokens (classic) need the `read:packages` scope to use this endpoint. For more information, see "[About
    /// permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func getAllPackageVersionsForPackageOwnedByUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String
    ) async throws -> [PackageVersion] {
        try await PackagesMethods.packagesGetAllPackageVersionsForPackageOwnedByUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username
...
public extension PackagesNamespace {
    ...
    /// access tokens (classic) need the `read:packages` scope to use this endpoint. For more information, see "[About
    /// permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func getPackageVersionForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        packageVersionId: Int,
        username: String
    ) async throws -> PackageVersion {
        try await PackagesMethods.packagesGetPackageVersionForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            packageVersionId: packageVersionId,
    ...
    ///
    /// Deletes a specific package version for a user. If the package is public and the package version has more than
    /// 5,000 downloads, you cannot delete the package version. In this scenario, contact GitHub support for further
    /// assistance. If the `package_type` belongs to a GitHub Packages registry that supports granular permissions, the
    /// authenticated user must have admin permissions to the package. For the list of these registries, see "[About
    /// permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages)."
    /// OAuth app tokens and personal access tokens (classic) need the `read:packages` and `delete:packages` scopes to
    /// use this endpoint. For more information, see "[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func deletePackageVersionForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String,
        packageVersionId: Int
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesDeletePackageVersionForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username,
    ...
    /// uses the deleted package's namespace first. If the `package_type` belongs to a GitHub Packages registry that
    /// supports granular permissions, the authenticated user must have admin permissions to the package. For the list
    /// of these registries, see "[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages)."
    /// OAuth app tokens and personal access tokens (classic) need the `read:packages` and `write:packages` scopes to
    /// use this endpoint. For more information, see "[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages)."
    func restorePackageVersionForUser(
        packageType: PackagesDeletePackageForOrgParameter,
        packageName: String,
        username: String,
        packageVersionId: Int
    ) async throws -> SdkEmptyResponse {
        try await PackagesMethods.packagesRestorePackageVersionForUser(
            config: config,
            packageType: packageType,
            packageName: packageName,
            username: username,
...
public class InteractionsNamespace {
    ...
    public func getRestrictionsForOrg(org: String) async throws -> InteractionsGetRestrictionsForOrgResponse {
        try await InteractionsMethods.interactionsGetRestrictionsForOrg(config: config, org: org)
    }
    ...
    /// organization.
    public func setRestrictionsForOrg(
        org: String,
        limit: InteractionGroup,
        expiry: InteractionExpiry?
    ) async throws -> InteractionLimitResponse {
        try await InteractionsMethods.interactionsSetRestrictionsForOrg(
            config: config,
            org: org,
            limit: limit,
            expiry: expiry
    ...
    public func removeRestrictionsForOrg(org: String) async throws -> SdkEmptyResponse {
        try await InteractionsMethods.interactionsRemoveRestrictionsForOrg(config: config, org: org)
    }
    ...
    public func getPullRequestCreationCapForOrg(org: String) async throws
        -> InteractionsGetPullRequestCreationCapForOrgResponse {
        try await InteractionsMethods.interactionsGetPullRequestCreationCapForOrg(config: config, org: org)
    }
    ...
    public func updatePullRequestCreationCapForOrg(
        org: String,
        enabled: Bool,
        maxOpenPullRequests: Int?
    ) async throws -> InteractionsUpdatePullRequestCreationCapForOrgResponse {
        try await InteractionsMethods.interactionsUpdatePullRequestCreationCapForOrg(
            config: config,
            org: org,
            enabled: enabled,
    ...
    public func getRestrictionsForRepo(
        owner: String,
        repo: String
    ) async throws -> InteractionsGetRestrictionsForRepoResponse {
        try await InteractionsMethods.interactionsGetRestrictionsForRepo(config: config, owner: owner, repo: repo)
    }
    ...
    public func setRestrictionsForRepo(
        owner: String,
        repo: String,
        limit: InteractionGroup,
        expiry: InteractionExpiry?
    ) async throws -> InteractionLimitResponse {
        try await InteractionsMethods.interactionsSetRestrictionsForRepo(
            config: config,
            owner: owner,
            repo: repo,
            limit: limit,
    ...
    public func removeRestrictionsForRepo(owner: String, repo: String) async throws -> SdkEmptyResponse {
        try await InteractionsMethods.interactionsRemoveRestrictionsForRepo(config: config, owner: owner, repo: repo)
    }
}

public extension InteractionsNamespace {
    /// Lists the users that are on the pull request creation cap bypass list for a repository. Users on this list can
    /// create pull requests regardless of any configured pull request creation cap. Only users with maintainer
    /// permissions can view the bypass list.
    func getPullRequestBypassListForRepo(owner: String, repo: String) async throws -> [SimpleUser] {
        try await InteractionsMethods.interactionsGetPullRequestBypassListForRepo(
            config: config,
            owner: owner,
            repo: repo
        )
    ...
    /// Adds users to the pull request creation cap bypass list for a repository. Users on this list can create pull
    /// requests regardless of any configured pull request creation cap. Only users with maintainer permissions can
    /// modify the bypass list. You can add a maximum of 100 users per request. The bypass list can only hold a maximum
    /// of 100 users.
    func setPullRequestBypassListForRepo(
        owner: String,
        repo: String,
        users: [String]
    ) async throws -> SdkEmptyResponse {
        try await InteractionsMethods.interactionsSetPullRequestBypassListForRepo(
            config: config,
            owner: owner,
            repo: repo,
            users: users
    ...
    func removePullRequestBypassListForRepo(
        owner: String,
        repo: String,
        users: [String]
    ) async throws -> SdkEmptyResponse {
        try await InteractionsMethods.interactionsRemovePullRequestBypassListForRepo(
            config: config,
            owner: owner,
            repo: repo,
            users: users
    ...
    /// configuration.
    func getPullRequestCreationCapForRepo(
        owner: String,
        repo: String
    ) async throws -> InteractionsGetPullRequestCreationCapForRepoResponse {
        try await InteractionsMethods.interactionsGetPullRequestCreationCapForRepo(
            config: config,
            owner: owner,
            repo: repo
        )
    ...
    func updatePullRequestCreationCapForRepo(
        owner: String,
        repo: String,
        enabled: Bool,
        maxOpenPullRequests: Int?
    ) async throws -> InteractionsUpdatePullRequestCreationCapForRepoResponse {
        try await InteractionsMethods.interactionsUpdatePullRequestCreationCapForRepo(
            config: config,
            owner: owner,
            repo: repo,
            enabled: enabled,
    ...
    func getRestrictionsForAuthenticatedUser() async throws -> InteractionsGetRestrictionsForAuthenticatedUserResponse {
        try await InteractionsMethods.interactionsGetRestrictionsForAuthenticatedUser(config: config)
    }
    ...
    func setRestrictionsForAuthenticatedUser(
        limit: InteractionGroup,
        expiry: InteractionExpiry?
    ) async throws -> InteractionLimitResponse {
        try await InteractionsMethods.interactionsSetRestrictionsForAuthenticatedUser(
            config: config,
            limit: limit,
            expiry: expiry
        )
    ...
    func removeRestrictionsForAuthenticatedUser() async throws -> SdkEmptyResponse {
        try await InteractionsMethods.interactionsRemoveRestrictionsForAuthenticatedUser(config: config)
    }
}
