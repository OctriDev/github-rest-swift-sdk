...
public extension SearchMethods {
    ...
    ///   y). See "[Searching
    ///   users](https://docs.github.com/search-github/searching-on-github/searching-u
    ///   sers)" for a detailed list of qualifiers.
    /// - sort: Sorts the results of your query by number of `followers` or
    ...
    static func searchUsers(
        ...
        ], decoder: .json, operationId: "searchUsers")).data
    }
}
