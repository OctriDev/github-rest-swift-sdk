...
extension ReposMethods {
    ...
    ///   not case sensitive.
    public static func reposGetCommunityProfileMetrics(config: ClientConfig, owner: String, repo: String) async throws -> CommunityProfile {
        return try (await sdkRequest("GET", ["/repos/", sdkEncodePathSegment(sdkWireString(owner)), "/", sdkEncodePathSegment(sdkWireString(repo)), "/community/profile"].joined(), config: config, decoder: .json, operationId: "reposGetCommunityProfileMetrics")).data
    }
}
