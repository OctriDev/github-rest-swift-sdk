...
public extension SearchMethods {
    ...
    /// - q: The search keywords. This endpoint does not accept qualifiers in the
    ///   query. To learn more about the format of the query, see [Constructing a
    ///   search
    ///   query](https://docs.github.com/rest/search/search#constructing-a-search-quer
    ///   y).
    /// - sort: Sorts the results of your query by when the label was `created` or
    ...
    static func searchLabels(
        ...
        ], decoder: .json, operationId: "searchLabels")).data
    }
}
