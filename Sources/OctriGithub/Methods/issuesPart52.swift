...
extension IssuesMethods {
    public struct IssuesListForAuthenticatedUserOptions: Codable {
        public var filter: IssuesListForAuthenticatedUserParameter?
        public var state: IssuesListForAuthenticatedUserParameterX0c8713b3?
        public var labels: String?
        public var sort: IssuesListForAuthenticatedUserParameterX317b1d71?
    ...
    ///   API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the
    ///   -rest-api)."
    public static func issuesListForAuthenticatedUser(config: ClientConfig, options: IssuesListForAuthenticatedUserOptions) async throws -> [Issue] {
        if let since = options.since {
            try sdkValidateDateTime("since", since)
        }

        return try (await sdkRequest("GET", "/user/issues", config: config, query: [
        ...
        ], decoder: .json, operationId: "issuesListForAuthenticatedUser")).data
    }
}
