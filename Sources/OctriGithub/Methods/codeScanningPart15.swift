...
extension CodeScanningMethods {
    ...
    ///   not case sensitive.
    public static func codeScanningListCodeqlDatabases(config: ClientConfig, owner: String, repo: String) async throws -> [CodeScanningCodeqlDatabase] {
        return try (await sdkRequest("GET", ["/repos/", sdkEncodePathSegment(sdkWireString(owner)), "/", sdkEncodePathSegment(sdkWireString(repo)), "/code-scanning/codeql/databases"].joined(), config: config, decoder: .json, operationId: "codeScanningListCodeqlDatabases")).data
    }
    ...
    public static func codeScanningGetCodeqlDatabase(config: ClientConfig, owner: String, repo: String, language: String) async throws -> CodeScanningCodeqlDatabase {
        return try (await sdkRequest("GET", ["/repos/", sdkEncodePathSegment(sdkWireString(owner)), "/", sdkEncodePathSegment(sdkWireString(repo)), "/code-scanning/codeql/databases/", sdkEncodePathSegment(sdkWireString(language))].joined(), config: config, decoder: .json, operationId: "codeScanningGetCodeqlDatabase")).data
    }
}
