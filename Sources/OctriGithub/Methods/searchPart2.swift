...
extension SearchMethods {
    ...
    ///   API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the
    ///   -rest-api)."
    public static func searchCode(config: ClientConfig, q: String, sort: SearchCodeParameter?, order: SearchCodeParameterX5b868389?, perPage: Int?, page: Int?) async throws -> SearchCodeResponse {
        return try (await sdkRequest("GET", "/search/code", config: config, query: [
