...
extension AppsMethods {
    ...
    ///   API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the
    ///   -rest-api)."
    public static func appsListPlans(config: ClientConfig, perPage: Int?, page: Int?) async throws -> [MarketplaceListingPlan] {
        return try (await sdkRequest("GET", "/marketplace_listing/plans", config: config, query: [
