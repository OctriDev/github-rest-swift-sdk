...
extension ActionsMethods {
    ...
    public static func actionsAddSelectedRepoToOrgSecret(config: ClientConfig, org: String, secretName: String, repositoryId: Int) async throws -> SdkEmptyResponse {
        return try (await sdkRequest("PUT", ["/orgs/", sdkEncodePathSegment(sdkWireString(org)), "/actions/secrets/", sdkEncodePathSegment(sdkWireString(secretName)), "/repositories/", sdkEncodePathSegment(sdkWireString(repositoryId))].joined(), config: config, decoder: .empty, operationId: "actionsAddSelectedRepoToOrgSecret")).data
    }
    ...
    /// - org: The organization name. The name is not case sensitive.
    /// - secretName: The name of the secret.
    public static func actionsRemoveSelectedRepoFromOrgSecret(config: ClientConfig, org: String, secretName: String, repositoryId: Int) async throws -> SdkEmptyResponse {
        return try (await sdkRequest("DELETE", ["/orgs/", sdkEncodePathSegment(sdkWireString(org)), "/actions/secrets/", sdkEncodePathSegment(sdkWireString(secretName)), "/repositories/", sdkEncodePathSegment(sdkWireString(repositoryId))].joined(), config: config, decoder: .empty, operationId: "actionsRemoveSelectedRepoFromOrgSecret")).data
    }
}
