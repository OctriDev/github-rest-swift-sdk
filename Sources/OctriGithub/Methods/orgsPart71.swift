...
public extension OrgsMethods {
    ...
    static func orgsEnableOrDisableSecurityProductOnAllOrgRepos(
        config: ClientConfig,
        org: String,
        ...
        return try await (sdkRequest(
            ...
            [
                ...
                "/",
                sdkEncodePathSegment(sdkWireString(securityProduct)),
                "/",
                sdkEncodePathSegment(sdkWireString(enablement)),
            ].joined(),
            config: config,
            body: requestBody,
            decoder: .empty,
