...
public extension ReposMethods {
    ...
    /// - name: The name pattern that branches must match in order to deploy to the
    ///   environment. Wildcard characters will not match `/`. For example, to match
    ///   branches that begin with `release/` and contain an additional single slash,
