...
public extension OrgsMethods {
    ...
    static func orgsListAttestationsBulk(
        config: ClientConfig,
        org: String,
        ...
        let requestBody = OrgsListAttestationsBulkRequestBody(
        ...
        return try await (sdkRequest(
            "POST",
            ["/orgs/", sdkEncodePathSegment(sdkWireString(org)), "/attestations/bulk-list"].joined(),
            config: config,
            query: [
