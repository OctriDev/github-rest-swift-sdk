...
public extension IssuesMethods {
    ...
    static func issuesGetEvent(
        ...
        try await (sdkRequest(
            ...
            [
                ...
                "/issues/events/",
                sdkEncodePathSegment(sdkWireString(eventId)),
            ].joined(),
            config: config,
            decoder: .json,
    ...
    static func issuesGet(config: ClientConfig, owner: String, repo: String, issueNumber: Int) async throws -> Issue {
        try await (sdkRequest(
            "GET",
            [
                "/repos/",
