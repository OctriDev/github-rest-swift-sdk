...
public extension IssuesMethods {
    struct IssuesListForOrgOptions: Codable {
    ...
    ///   API](https://docs.github.com/rest/using-the-rest-api/using-pagination-in-the
    ///   -rest-api)."
    static func issuesListForOrg(config: ClientConfig, options: IssuesListForOrgOptions) async throws -> [Issue] {
        ...
        return try await (sdkRequest(
            "GET",
            ["/orgs/", sdkEncodePathSegment(sdkWireString(options.org)), "/issues"].joined(),
            config: config,
            query: [
