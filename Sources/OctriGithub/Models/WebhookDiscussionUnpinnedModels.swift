...
// WebhookDiscussionUnpinned domain models
/// Typed representation of the `WebhookDiscussionUnpinned` API schema.
public struct WebhookDiscussionUnpinned: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionUnpinnedAction
...
public extension WebhookDiscussionUnpinned {
...
public extension WebhookDiscussionUnpinned {
    public init(action: WebhookDiscussionUnpinnedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionUnpinnedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let unpinned = WebhookDiscussionUnpinnedAction(rawValue: "unpinned")
