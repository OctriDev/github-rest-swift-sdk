...
public extension WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledByType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewDismissedPullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewDismissedPullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewDismissedPullRequestBaseUser?
    ) {
