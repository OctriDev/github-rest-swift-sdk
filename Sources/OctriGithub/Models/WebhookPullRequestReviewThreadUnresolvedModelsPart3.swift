...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEX6bfa606e7a? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseUser?
    ) {
