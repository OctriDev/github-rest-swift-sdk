...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy {
...
extension WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy {
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBase {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBase {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo, sha: String, user: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseUser?) {
...
/// A git repository
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoCreatedAt
    ...
    public var license: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense?
    ...
    public var owner: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPuX5d11579df1?
    ...
    public var permissions: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions?
