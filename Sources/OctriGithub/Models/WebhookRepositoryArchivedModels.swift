...
// WebhookRepositoryArchived domain models
/// Typed representation of the `WebhookRepositoryArchived` API schema.
public struct WebhookRepositoryArchived: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryArchivedAction
...
public extension WebhookRepositoryArchived {
...
public extension WebhookRepositoryArchived {
    public init(action: WebhookRepositoryArchivedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryArchivedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let archived = WebhookRepositoryArchivedAction(rawValue: "archived")
