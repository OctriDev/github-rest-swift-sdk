...
public struct WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestAutoMergeEnabledPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestAutoMergeEnabledPullRequestBaseUserType?
...
public extension WebhookPullRequestAutoMergeEnabledPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestAutoMergeEnabledPullRequestBaseUser {
...
public struct WebhookPullRequestAutoMergeEnabledPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestAutoMergeEnabledPullRequestHeadRepo
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestAutoMergeEnabledPullRequestHeadUser?
...
public extension WebhookPullRequestAutoMergeEnabledPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestAutoMergeEnabledPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestAutoMergeEnabledPullRequestHeadRepo, sha: String, user: WebhookPullRequestAutoMergeEnabledPullRequestHeadUser?) {
