...
/// A git repository
public struct WebhookPullRequestDequeuedPullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestDequeuedPullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestDequeuedPullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestDequeuedPullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestDequeuedPullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestDequeuedPullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy?
    ...
    public var mergeCommitMessage: WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestDequeuedPullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle?
...
public extension WebhookPullRequestDequeuedPullRequestHeadRepo {
...
public extension WebhookPullRequestDequeuedPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestDequeuedPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestDequeuedPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestDequeuedPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestDequeuedPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestDequeuedPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestDequeuedPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestDequeuedPullRequestHeadRepo {
...
public enum WebhookPullRequestDequeuedPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
