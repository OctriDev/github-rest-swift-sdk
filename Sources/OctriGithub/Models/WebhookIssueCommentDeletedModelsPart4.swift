...
public struct WebhookIssueCommentDeletedIssueVariant0PullRequest: Codable {
...
extension WebhookIssueCommentDeletedIssueVariant0PullRequest {
...
public struct WebhookIssueCommentDeletedIssueVariant0Reactions: Codable {
...
extension WebhookIssueCommentDeletedIssueVariant0Reactions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookIssueCommentDeletedIssueVariant0User: Codable {
    ...
    public var type: WebhookIssueCommentDeletedIssueVariant0UserType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
...
public struct WebhookIssueCommentDeletedIssueVariant1: Codable {
