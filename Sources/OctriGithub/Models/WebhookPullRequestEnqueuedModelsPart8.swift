...
public extension WebhookPullRequestEnqueuedPullRequestLabelsItem {
...
public struct WebhookPullRequestEnqueuedPullRequestMergedBy: Codable {
    ...
    public var type: WebhookPullRequestEnqueuedPullRequestMergedByType?
...
public extension WebhookPullRequestEnqueuedPullRequestMergedBy {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
extension WebhookPullRequestEnqueuedPullRequestMergedBy {
...
public struct WebhookPullRequestEnqueuedPullRequestMilestone: Codable {
    ...
    public var creator: WebhookPullRequestEnqueuedPullRequestMilestoneCreator?
    ...
    public var state: WebhookPullRequestEnqueuedPullRequestMilestoneState
...
public extension WebhookPullRequestEnqueuedPullRequestMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestEnqueuedPullRequestMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookPullRequestEnqueuedPullRequestMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookPullRequestEnqueuedPullRequestMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookPullRequestEnqueuedPullRequestMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookPullRequestEnqueuedPullRequestMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestEnqueuedPullRequestMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestEnqueuedPullRequestMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestEnqueuedPullRequestMilestoneCreator {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public enum WebhookPullRequestEnqueuedPullRequestRequestedReviewersItem {
    case webhookPullRequestEnqueuedPullRequestRequestedReviewersItemVariant0(
        WebhookPullRequestEnqueuedPullRequestRequestedReviewersItemVariant0
    )
    case webhookPullRequestEnqueuedPullRequestRequestedReviewersItemVariant1(
        WebhookPullRequestEnqueuedPullRequestRequestedReviewersItemVariant1
    )
}
