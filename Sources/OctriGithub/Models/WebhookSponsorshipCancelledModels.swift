...
// WebhookSponsorshipCancelled domain models
/// Typed representation of the `WebhookSponsorshipCancelled` API schema.
public struct WebhookSponsorshipCancelled: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSponsorshipCancelledAction
    /// A GitHub user.
...
public extension WebhookSponsorshipCancelled {
...
public extension WebhookSponsorshipCancelled {
    public init(action: WebhookSponsorshipCancelledAction, sender: SimpleUser, sponsorship: WebhooksSponsorship, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, repository: RepositoryWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSponsorshipCancelledAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let cancelled = WebhookSponsorshipCancelledAction(rawValue: "cancelled")
