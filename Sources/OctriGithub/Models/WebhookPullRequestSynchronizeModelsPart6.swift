...
/// A git repository
public struct WebhookPullRequestSynchronizePullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestSynchronizePullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestSynchronizePullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestSynchronizePullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestSynchronizePullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestSynchronizePullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestSynchronizePullRequestHeadRepoPullRequestCrX15133fa90d?
    ...
    public var mergeCommitMessage: WebhookPullRequestSynchronizePullRequestHeadRepoMergeCommitMessage?
    /// The default value for a merge commit message title.
    public var mergeCommitTitle: WebhookPullRequestSynchronizePullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestSynchronizePullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestSynchronizePullRequestHeadRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestSynchronizePullRequestHeadRepoSquashMergeCommitTitle?
...
public extension WebhookPullRequestSynchronizePullRequestHeadRepo {
...
public extension WebhookPullRequestSynchronizePullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestSynchronizePullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestSynchronizePullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestSynchronizePullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestSynchronizePullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestSynchronizePullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestSynchronizePullRequestHeadRepoPullRequestCrX15133fa90d? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestSynchronizePullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestSynchronizePullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestSynchronizePullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestSynchronizePullRequestHeadRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhookPullRequestSynchronizePullRequestHeadRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestSynchronizePullRequestHeadRepo {
...
public enum WebhookPullRequestSynchronizePullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
