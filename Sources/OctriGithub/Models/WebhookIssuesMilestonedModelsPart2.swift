...
public extension WebhookIssuesMilestonedIssueAssigneesItem {
...
extension WebhookIssuesMilestonedIssueAssigneesItem {
...
public struct WebhookIssuesMilestonedIssueLabelsItem: Codable {
...
public extension WebhookIssuesMilestonedIssueLabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookIssuesMilestonedIssueMilestone: Codable {
    ...
    public var creator: WebhookIssuesMilestonedIssueMilestoneCreator?
    /// Required `string` value serialized in the `description` wire field.
    public var description: String?
    ...
    public var state: WebhookIssuesMilestonedIssueMilestoneState
...
public extension WebhookIssuesMilestonedIssueMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookIssuesMilestonedIssueMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookIssuesMilestonedIssueMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookIssuesMilestonedIssueMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookIssuesMilestonedIssueMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookIssuesMilestonedIssueMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    ...
    public var type: WebhookIssuesMilestonedIssueMilestoneCreatorType?
...
public extension WebhookIssuesMilestonedIssueMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookIssuesMilestonedIssueMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookIssuesMilestonedIssueMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookIssuesMilestonedIssueMilestoneCreator {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookIssuesMilestonedIssuePerformedViaGithubApp: Codable {
    /// Required `date-time`-formatted value serialized in the `created_at` wire field.
    public var createdAt: Date?
    /// Required `string` value serialized in the `description` wire field.
    public var description: String?
    ...
    public var owner: WebhookIssuesMilestonedIssuePerformedViaGithubAppOwner?
    /// Required `date-time`-formatted value serialized in the `updated_at` wire field.
    public var updatedAt: Date?
    /// The list of events for the GitHub app
    public var events: [WebhookIssuesMilestonedIssuePerformedViaGithubAppEventsItem]?
    /// The set of permissions for the GitHub app
    public var permissions: WebhookIssuesMilestonedIssuePerformedViaGithubAppPermissions?
