...
// WebhookDiscussionCreated domain models
/// Typed representation of the `WebhookDiscussionCreated` API schema.
public struct WebhookDiscussionCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionCreatedAction
...
public extension WebhookDiscussionCreated {
...
public extension WebhookDiscussionCreated {
    public init(action: WebhookDiscussionCreatedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookDiscussionCreatedAction(rawValue: "created")
