...
extension WebhooksPullRequest5AutoMergeEnabledBy {
...
public extension WebhooksPullRequest5Base {
...
public extension WebhooksPullRequest5Base {
    public init(label: String, ref: String, repo: WebhooksPullRequest5BaseRepo, sha: String, user: WebhooksPullRequest5BaseUser?) {
...
/// A git repository
public struct WebhooksPullRequest5BaseRepo: Codable {
    ...
    public var createdAt: WebhooksPullRequest5BaseRepoCreatedAt
    ...
    public var license: WebhooksPullRequest5BaseRepoLicense?
    ...
    public var owner: WebhooksPullRequest5BaseRepoOwner?
    ...
    public var pushedAt: WebhooksPullRequest5BaseRepoPushedAt?
    ...
    public var visibility: WebhooksPullRequest5BaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhooksPullRequest5BaseRepoPullRequestCreationPolicy?
    ...
    public var mergeCommitMessage: WebhooksPullRequest5BaseRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhooksPullRequest5BaseRepoMergeCommitTitle?
    ...
    public var permissions: WebhooksPullRequest5BaseRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhooksPullRequest5BaseRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhooksPullRequest5BaseRepoSquashMergeCommitTitle?
...
public extension WebhooksPullRequest5BaseRepo {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
