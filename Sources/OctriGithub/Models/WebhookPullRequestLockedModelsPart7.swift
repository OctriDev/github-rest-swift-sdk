...
extension WebhookPullRequestLockedPullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestLockedPullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestLockedPullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestLockedPullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestLockedPullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestLockedPullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestLockedPullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestLockedPullRequestHeadRepoOwner {
...
public struct WebhookPullRequestLockedPullRequestHeadRepoPermissions: Codable {
...
public extension WebhookPullRequestLockedPullRequestHeadRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestLockedPullRequestHeadRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestLockedPullRequestHeadRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestLockedPullRequestHeadRepoPushedAt")
    }
...
public struct WebhookPullRequestLockedPullRequestHeadUser: Codable {
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestLockedPullRequestHeadUserType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestLockedPullRequestHeadUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestLockedPullRequestHeadUser {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestLockedPullRequestHeadUserType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestLockedPullRequestHeadUser {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestLockedPullRequestLabelsItem: Codable {
