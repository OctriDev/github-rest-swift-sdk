...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX80f89dd893, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadXe49d78684c?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX5f9cd309d1, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX5143f24797? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX28f85e0c71? = nil, mergeCommitTitle: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadXe4b14c4e64? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX22a105320c? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX23e04b9611? = nil, squashMergeCommitTitle: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX7b6810c64b? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepo {
...
public enum WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX80f89dd893 {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX80f89dd893: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX80f89dd893")
    }
...
public struct WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoOwner: Codable {
    public var id: Int
    ...
    public var type: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX1f4c48c46d?
    public var url: String?
...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepoOwner {
...
public struct WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX22a105320c: Codable {
...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadX22a105320c {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadXe49d78684c {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadXe49d78684c: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadXe49d78684c")
    }
...
public struct WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadUser: Codable {
    public var id: Int
    public var login: String
    public var avatarUrl: String?
    public var deleted: Bool?
    ...
    public var starredUrl: String?
    public var subscriptionsUrl: String?
    public var type: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadUserType?
    public var url: String?
    public var userViewType: String?
