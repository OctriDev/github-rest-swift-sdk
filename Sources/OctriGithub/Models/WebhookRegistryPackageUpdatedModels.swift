...
extension WebhookRegistryPackageUpdated {
...
extension WebhookRegistryPackageUpdatedRegistryPackage {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookRegistryPackageUpdatedRegistryPackageOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookRegistryPackageUpdatedRegistryPackagePackageVersion {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookRegistryPackageUpdatedRegistryPackagePackageVersionAuthor {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.avatarUrl = try container.sdkDecodeRequired(.avatarUrl)
        self.eventsUrl = try container.sdkDecodeRequired(.eventsUrl)
...
extension WebhookRegistryPackageUpdatedRegistryPackagePackageVersionDocXca10b905e1 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
