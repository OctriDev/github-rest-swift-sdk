...
public extension WebhookPersonalAccessTokenRequestCancelled {
    init(
        action: WebhookPersonalAccessTokenRequestCancelledAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPersonalAccessTokenRequestCancelledAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
