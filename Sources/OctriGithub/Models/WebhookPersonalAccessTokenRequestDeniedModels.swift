...
// WebhookPersonalAccessTokenRequestDenied domain models
/// Typed representation of the `WebhookPersonalAccessTokenRequestDenied` API schema.
public struct WebhookPersonalAccessTokenRequestDenied: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookPersonalAccessTokenRequestDeniedAction
...
public extension WebhookPersonalAccessTokenRequestDenied {
...
public extension WebhookPersonalAccessTokenRequestDenied {
    public init(action: WebhookPersonalAccessTokenRequestDeniedAction, personalAccessTokenRequest: PersonalAccessTokenRequest, organization: OrganizationSimpleWebhooks, sender: SimpleUser, installation: SimpleInstallation, enterprise: EnterpriseWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPersonalAccessTokenRequestDeniedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let denied = WebhookPersonalAccessTokenRequestDeniedAction(rawValue: "denied")
