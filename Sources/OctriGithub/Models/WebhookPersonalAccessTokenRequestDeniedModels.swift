...
public extension WebhookPersonalAccessTokenRequestDenied {
    init(
        action: WebhookPersonalAccessTokenRequestDeniedAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPersonalAccessTokenRequestDeniedAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
