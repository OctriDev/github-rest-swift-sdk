...
public struct WebhookPullRequestDequeuedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestDequeuedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestDequeuedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestDequeuedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestDequeuedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestDequeuedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestDequeuedPullRequestBaseUserType?
...
public extension WebhookPullRequestDequeuedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestDequeuedPullRequestBaseUser {
...
public struct WebhookPullRequestDequeuedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestDequeuedPullRequestHeadRepo
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestDequeuedPullRequestHeadUser?
...
public extension WebhookPullRequestDequeuedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestDequeuedPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestDequeuedPullRequestHeadRepo, sha: String, user: WebhookPullRequestDequeuedPullRequestHeadUser?) {
