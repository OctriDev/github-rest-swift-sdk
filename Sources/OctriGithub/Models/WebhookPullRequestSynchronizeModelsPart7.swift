...
extension WebhookPullRequestSynchronizePullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestSynchronizePullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestSynchronizePullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestSynchronizePullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestSynchronizePullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestSynchronizePullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestSynchronizePullRequestHeadRepoOwner {
...
public struct WebhookPullRequestSynchronizePullRequestHeadRepoPermissions: Codable {
...
public extension WebhookPullRequestSynchronizePullRequestHeadRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestSynchronizePullRequestHeadRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestSynchronizePullRequestHeadRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestSynchronizePullRequestHeadRepoPushedAt")
    }
...
public struct WebhookPullRequestSynchronizePullRequestHeadUser: Codable {
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestSynchronizePullRequestHeadUserType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestSynchronizePullRequestHeadUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestSynchronizePullRequestHeadUser {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestSynchronizePullRequestHeadUserType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestSynchronizePullRequestHeadUser {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestSynchronizePullRequestLabelsItem: Codable {
