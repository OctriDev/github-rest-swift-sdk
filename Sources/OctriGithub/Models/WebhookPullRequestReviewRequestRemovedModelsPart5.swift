...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestBaseUser {
    init(
        ...
        type: WebhookPullRequestReviewRequestRemovedVariant0PullRequestBaseUserType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewRequestRemovedVariant0PullRequestHead {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadRepo,
        sha: String,
        user: WebhookPullRequestReviewRequestRemovedVariant0PullRequestHeadUser?
    ) {
