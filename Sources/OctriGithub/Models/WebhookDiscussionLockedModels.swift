...
// WebhookDiscussionLocked domain models
/// Typed representation of the `WebhookDiscussionLocked` API schema.
public struct WebhookDiscussionLocked: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionLockedAction
...
public extension WebhookDiscussionLocked {
...
public extension WebhookDiscussionLocked {
    public init(action: WebhookDiscussionLockedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionLockedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let locked = WebhookDiscussionLockedAction(rawValue: "locked")
