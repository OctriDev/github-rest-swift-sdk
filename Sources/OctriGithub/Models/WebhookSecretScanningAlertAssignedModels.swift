...
// WebhookSecretScanningAlertAssigned domain models
/// Typed representation of the `WebhookSecretScanningAlertAssigned` API schema.
public struct WebhookSecretScanningAlertAssigned: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertAssignedAction
...
public extension WebhookSecretScanningAlertAssigned {
...
public extension WebhookSecretScanningAlertAssigned {
    public init(action: WebhookSecretScanningAlertAssignedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, assignee: SimpleUser? = nil, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertAssignedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let assigned = WebhookSecretScanningAlertAssignedAction(rawValue: "assigned")
