...
public extension WebhooksIssue2AssigneesItem {
    init(
        ...
        type: WebhooksIssue2AssigneesItemType? = nil,
        url: String? = nil,
...
public extension WebhooksIssue2Milestone {
    init(
        ...
        closedIssues: Int,
        createdAt: Date,
        creator: WebhooksIssue2MilestoneCreator?,
        description: String?,
        dueOn: Date?,
        htmlUrl: String,
        id: Int,
        ...
        number: Int,
        openIssues: Int,
        state: WebhooksIssue2MilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
...
public extension WebhooksIssue2MilestoneCreator {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhooksIssue2MilestoneCreatorType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
