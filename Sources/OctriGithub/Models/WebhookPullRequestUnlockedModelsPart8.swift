...
public extension WebhookPullRequestUnlockedPullRequestLabelsItem {
...
public struct WebhookPullRequestUnlockedPullRequestMergedBy: Codable {
    ...
    public var type: WebhookPullRequestUnlockedPullRequestMergedByType?
...
public extension WebhookPullRequestUnlockedPullRequestMergedBy {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
extension WebhookPullRequestUnlockedPullRequestMergedBy {
...
public struct WebhookPullRequestUnlockedPullRequestMilestone: Codable {
    ...
    public var creator: WebhookPullRequestUnlockedPullRequestMilestoneCreator?
    ...
    public var state: WebhookPullRequestUnlockedPullRequestMilestoneState
...
public extension WebhookPullRequestUnlockedPullRequestMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestUnlockedPullRequestMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookPullRequestUnlockedPullRequestMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookPullRequestUnlockedPullRequestMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookPullRequestUnlockedPullRequestMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookPullRequestUnlockedPullRequestMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestUnlockedPullRequestMilestoneCreatorType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestUnlockedPullRequestMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestUnlockedPullRequestMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestUnlockedPullRequestMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestUnlockedPullRequestMilestoneCreator {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public enum WebhookPullRequestUnlockedPullRequestRequestedReviewersItem {
    case webhookPullRequestUnlockedPullRequestRequestedReviewersItemVariant0(
        WebhookPullRequestUnlockedPullRequestRequestedReviewersItemVariant0
    )
    case webhookPullRequestUnlockedPullRequestRequestedReviewersItemVariant1(
        WebhookPullRequestUnlockedPullRequestRequestedReviewersItemVariant1
    )
}
