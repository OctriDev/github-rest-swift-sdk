...
public extension WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy {
...
extension WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy {
...
public extension WebhookPullRequestReviewCommentCreatedPullRequestBase {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewCommentCreatedPullRequestBase {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo, sha: String, user: WebhookPullRequestReviewCommentCreatedPullRequestBaseUser?) {
...
/// A git repository
public struct WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoCreatedAt
    ...
    public var license: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicense?
    ...
    public var owner: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPullX2b489ed467?
    ...
    public var mergeCommitMessage: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergX2c6799a4d5?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergX59205db385?
    ...
    public var permissions: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquaX801f2999fb?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquaXe8e250fcbe?
...
public extension WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
