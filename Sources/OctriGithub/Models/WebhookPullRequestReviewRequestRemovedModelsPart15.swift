...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoLicense {
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadX1ceb0eec6e {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestLabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
