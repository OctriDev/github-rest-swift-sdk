...
public extension WebhookDependabotAlertAssigneesChanged {
    init(
        action: WebhookDependabotAlertAssigneesChangedAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDependabotAlertAssigneesChangedAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
