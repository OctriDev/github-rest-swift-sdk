...
// WebhookDependabotAlertAssigneesChanged domain models
/// Typed representation of the `WebhookDependabotAlertAssigneesChanged` API schema.
public struct WebhookDependabotAlertAssigneesChanged: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDependabotAlertAssigneesChangedAction
    /// A Dependabot alert.
...
public extension WebhookDependabotAlertAssigneesChanged {
...
public extension WebhookDependabotAlertAssigneesChanged {
    public init(action: WebhookDependabotAlertAssigneesChangedAction, alert: DependabotAlert, repository: RepositoryWebhooks, sender: SimpleUser, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, enterprise: EnterpriseWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDependabotAlertAssigneesChangedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let assigneesChanged = WebhookDependabotAlertAssigneesChangedAction(rawValue: "assignees_changed")
