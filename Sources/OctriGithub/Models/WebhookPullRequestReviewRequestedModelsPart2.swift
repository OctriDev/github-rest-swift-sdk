...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestAssignee {
    init(
        ...
        type: WebhookPullRequestReviewRequestedVariant0PullRequestAssigneeType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestAssigneesItem {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookPullRequestReviewRequestedVariant0PullRequestAssigneesItemType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestAutoMerge {
    init(
        ...
        commitTitle: String?,
        enabledBy: WebhookPullRequestReviewRequestedVariant0PullRequestAutoMergeEnabledBy?,
        mergeMethod: WebhookPullRequestReviewRequestedVariant0PullRequestAutoMergeMergeMethod
    ) {
