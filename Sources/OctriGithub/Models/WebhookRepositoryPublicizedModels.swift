...
// WebhookRepositoryPublicized domain models
/// Typed representation of the `WebhookRepositoryPublicized` API schema.
public struct WebhookRepositoryPublicized: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryPublicizedAction
...
public extension WebhookRepositoryPublicized {
...
public extension WebhookRepositoryPublicized {
    public init(action: WebhookRepositoryPublicizedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryPublicizedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let publicized = WebhookRepositoryPublicizedAction(rawValue: "publicized")
