...
// WebhookStarCreated domain models
/// Typed representation of the `WebhookStarCreated` API schema.
public struct WebhookStarCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookStarCreatedAction
...
public extension WebhookStarCreated {
...
public extension WebhookStarCreated {
    public init(action: WebhookStarCreatedAction, repository: RepositoryWebhooks, sender: SimpleUser, starredAt: String?, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookStarCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookStarCreatedAction(rawValue: "created")
