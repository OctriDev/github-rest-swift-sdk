...
public extension WebhookSecretScanningAlertPubliclyLeaked {
    init(
        action: WebhookSecretScanningAlertPubliclyLeakedAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertPubliclyLeakedAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
