...
// WebhookSecretScanningAlertPubliclyLeaked domain models
/// Typed representation of the `WebhookSecretScanningAlertPubliclyLeaked` API schema.
public struct WebhookSecretScanningAlertPubliclyLeaked: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertPubliclyLeakedAction
...
public extension WebhookSecretScanningAlertPubliclyLeaked {
...
public extension WebhookSecretScanningAlertPubliclyLeaked {
    public init(action: WebhookSecretScanningAlertPubliclyLeakedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertPubliclyLeakedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let publiclyLeaked = WebhookSecretScanningAlertPubliclyLeakedAction(rawValue: "publicly_leaked")
