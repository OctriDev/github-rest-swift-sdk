...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense {
    public init(from decoder: Decoder) throws {
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
