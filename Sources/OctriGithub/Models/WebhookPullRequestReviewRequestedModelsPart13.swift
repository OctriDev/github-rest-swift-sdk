...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense: Codable {
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner: Codable {
    public var id: Int
    ...
    public var type: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwnerType?
    public var url: String?
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner {
...
public struct WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser: Codable {
    public var id: Int
    public var login: String
    public var avatarUrl: String?
    public var deleted: Bool?
    ...
    public var starredUrl: String?
    public var subscriptionsUrl: String?
    public var type: WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType?
    public var url: String?
    public var userViewType: String?
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestReviewRequestedVariant1PullRequestHead: Codable {
    public var label: String
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepo
    public var sha: String
    /// User
    public var user: WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser?
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepo, sha: String, user: WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser?) {
