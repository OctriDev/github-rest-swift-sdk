...
// WebhookPullRequestClosed domain models
/// Typed representation of the `WebhookPullRequestClosed` API schema.
public struct WebhookPullRequestClosed: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookPullRequestClosedAction
...
public extension WebhookPullRequestClosed {
...
public extension WebhookPullRequestClosed {
    public init(action: WebhookPullRequestClosedAction, number: WebhooksNumber, pullRequest: PullRequestWebhook, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPullRequestClosedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let closed = WebhookPullRequestClosedAction(rawValue: "closed")
