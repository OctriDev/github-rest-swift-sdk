...
public extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepo {
...
public extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPullX0ac5f4eb8e? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoMergX7181882c09? = nil, mergeCommitTitle: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoMergXa011e7eefb? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoSquaXb1371e60a0? = nil, squashMergeCommitTitle: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoSquaX7c4bd1734a? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepo {
...
public enum WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewCommentDeletedPullRequestHeadRepoOwner {
