...
public extension WebhooksRelease1 {
    init(
        assets: [WebhooksRelease1AssetsItem?],
        assetsUrl: String,
        author: WebhooksRelease1Author?,
        body: String?,
        createdAt: Date?,
        draft: Bool,
        htmlUrl: String,
        ...
        reactions: WebhooksRelease1Reactions? = nil
    ) throws {
...
public extension WebhooksRelease1AssetsItem {
    init(
        ...
        size: Int,
        digest: String?,
        state: WebhooksRelease1AssetsItemState,
        updatedAt: Date,
        url: String,
        uploader: WebhooksRelease1AssetsItemUploader? = nil
    ) throws {
...
public extension WebhooksRelease1AssetsItemUploader {
    init(
        ...
        type: WebhooksRelease1AssetsItemUploaderType? = nil,
        url: String? = nil
    ) throws {
