...
// WebhookSecretScanningAlertResolved domain models
/// Typed representation of the `WebhookSecretScanningAlertResolved` API schema.
public struct WebhookSecretScanningAlertResolved: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertResolvedAction
...
public extension WebhookSecretScanningAlertResolved {
...
public extension WebhookSecretScanningAlertResolved {
    public init(action: WebhookSecretScanningAlertResolvedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertResolvedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let resolved = WebhookSecretScanningAlertResolvedAction(rawValue: "resolved")
