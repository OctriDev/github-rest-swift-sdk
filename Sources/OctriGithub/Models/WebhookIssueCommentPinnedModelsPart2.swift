...
public extension WebhookIssueCommentPinnedIssueVariant0Assignee {
    init(
        ...
        type: WebhookIssueCommentPinnedIssueVariant0AssigneeType? = nil,
        url: String? = nil,
...
public extension WebhookIssueCommentPinnedIssueVariant0AssigneesItem {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookIssueCommentPinnedIssueVariant0AssigneesItemType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
...
public extension WebhookIssueCommentPinnedIssueVariant0Milestone {
    init(
        ...
        number: Int,
        openIssues: Int,
        state: WebhookIssueCommentPinnedIssueVariant0MilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
