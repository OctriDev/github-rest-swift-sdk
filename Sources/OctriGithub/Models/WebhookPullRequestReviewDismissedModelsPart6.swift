...
public extension WebhookPullRequestReviewDismissedPullRequestHeadRepo {
...
public extension WebhookPullRequestReviewDismissedPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewDismissedPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewDismissedPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequeXcd8359580e? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewDismissedPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMerX3f96053f3a? = nil, squashMergeCommitTitle: WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMerXdba5efcd2e? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewDismissedPullRequestHeadRepo {
...
public enum WebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewDismissedPullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewDismissedPullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestReviewDismissedPullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner {
