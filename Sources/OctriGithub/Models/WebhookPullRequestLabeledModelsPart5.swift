...
public struct WebhookPullRequestLabeledPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestLabeledPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestLabeledPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestLabeledPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestLabeledPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestLabeledPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestLabeledPullRequestBaseUserType?
...
public extension WebhookPullRequestLabeledPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestLabeledPullRequestBaseUser {
...
public struct WebhookPullRequestLabeledPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String?
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestLabeledPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestLabeledPullRequestHeadUser?
...
public extension WebhookPullRequestLabeledPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestLabeledPullRequestHead {
    public init(label: String?, ref: String, repo: WebhookPullRequestLabeledPullRequestHeadRepo?, sha: String, user: WebhookPullRequestLabeledPullRequestHeadUser?) {
