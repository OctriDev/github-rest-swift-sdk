...
public struct WebhookProjectCardEdited: Codable {
    ...
    public var action: WebhookProjectCardEditedAction
    /// Required object value serialized in the `changes` wire field.
    public var changes: WebhookProjectCardEditedChanges
...
/// Required object value serialized in the `changes` wire field.
public struct WebhookProjectCardEditedChanges: Codable {
    /// Required object value serialized in the `note` wire field.
    public var note: WebhookProjectCardEditedChangesNote
...
/// Required object value serialized in the `note` wire field.
public struct WebhookProjectCardEditedChangesNote: Codable {
