...
public extension WebhookIssuesTransferredChangesNewRepository {
...
public extension WebhookIssuesTransferredChangesNewRepository {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookIssuesTransferredChangesNewRepositoryCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookIssuesTransferredChangesNewRepositoryLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookIssuesTransferredChangesNewRepositoryOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookIssuesTransferredChangesNewRepositoryPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookIssuesTransferredChangesNewRepositoryVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, customProperties: [String: JSONValue]? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, organization: String? = nil, permissions: WebhookIssuesTransferredChangesNewRepositoryPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, stargazers: Int? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookIssuesTransferredChangesNewRepository {
...
public enum WebhookIssuesTransferredChangesNewRepositoryCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookIssuesTransferredChangesNewRepositoryCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookIssuesTransferredChangesNewRepositoryCreatedAt")
    }
...
public struct WebhookIssuesTransferredChangesNewRepositoryLicense: Codable {
...
public extension WebhookIssuesTransferredChangesNewRepositoryLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookIssuesTransferredChangesNewRepositoryOwner: Codable {
    ...
    public var type: WebhookIssuesTransferredChangesNewRepositoryOwnerType?
...
public extension WebhookIssuesTransferredChangesNewRepositoryOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssuesTransferredChangesNewRepositoryOwner {
...
public struct WebhookIssuesTransferredChangesNewRepositoryPermissions: Codable {
