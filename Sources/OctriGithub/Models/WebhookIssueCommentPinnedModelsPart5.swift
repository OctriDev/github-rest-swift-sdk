...
extension WebhookIssueCommentPinnedIssueVariant1AssigneesItem {
    public init() {
    }
}
...
extension WebhookIssueCommentPinnedIssueVariant1LabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentPinnedIssueVariant1Milestone {
    public init() {
    }
}
...
extension WebhookIssueCommentPinnedIssueVariant1PerformedViaGithubApp {
    public init() {
    }
}
...
extension WebhookIssueCommentPinnedIssueVariant1Reactions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentPinnedIssueVariant1User {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.avatarUrl = try container.sdkDecodeIfPresent(.avatarUrl)
        self.eventsUrl = try container.sdkDecodeIfPresent(.eventsUrl)
