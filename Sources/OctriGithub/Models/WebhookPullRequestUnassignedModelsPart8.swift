...
public extension WebhookPullRequestUnassignedPullRequestLabelsItem {
...
public struct WebhookPullRequestUnassignedPullRequestMergedBy: Codable {
    ...
    public var type: WebhookPullRequestUnassignedPullRequestMergedByType?
...
public extension WebhookPullRequestUnassignedPullRequestMergedBy {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
extension WebhookPullRequestUnassignedPullRequestMergedBy {
...
public struct WebhookPullRequestUnassignedPullRequestMilestone: Codable {
    ...
    public var creator: WebhookPullRequestUnassignedPullRequestMilestoneCreator?
    ...
    public var state: WebhookPullRequestUnassignedPullRequestMilestoneState
...
public extension WebhookPullRequestUnassignedPullRequestMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestUnassignedPullRequestMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookPullRequestUnassignedPullRequestMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookPullRequestUnassignedPullRequestMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookPullRequestUnassignedPullRequestMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookPullRequestUnassignedPullRequestMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestUnassignedPullRequestMilestoneCreatorType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestUnassignedPullRequestMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestUnassignedPullRequestMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestUnassignedPullRequestMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestUnassignedPullRequestMilestoneCreator {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public enum WebhookPullRequestUnassignedPullRequestRequestedReviewersItem {
    case webhookPullRequestUnassignedPullRequestRequestedReviewersItemVariant0(
        WebhookPullRequestUnassignedPullRequestRequestedReviewersItemVariant0
    )
    case webhookPullRequestUnassignedPullRequestRequestedReviewersItemVariant1(
        WebhookPullRequestUnassignedPullRequestRequestedReviewersItemVariant1
    )
}
