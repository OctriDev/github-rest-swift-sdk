...
public extension WebhookSecretScanningAlertMetadataCreated {
    init(
        action: WebhookSecretScanningAlertMetadataCreatedAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertMetadataCreatedAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
