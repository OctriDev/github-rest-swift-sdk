...
// WebhookSecretScanningAlertMetadataCreated domain models
/// Typed representation of the `WebhookSecretScanningAlertMetadataCreated` API schema.
public struct WebhookSecretScanningAlertMetadataCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertMetadataCreatedAction
...
public extension WebhookSecretScanningAlertMetadataCreated {
...
public extension WebhookSecretScanningAlertMetadataCreated {
    public init(action: WebhookSecretScanningAlertMetadataCreatedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertMetadataCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let metadataCreated = WebhookSecretScanningAlertMetadataCreatedAction(rawValue: "metadata_created")
