...
public extension WebhookPullRequestLockedPullRequestLabelsItem {
...
public struct WebhookPullRequestLockedPullRequestMergedBy: Codable {
    ...
    public var type: WebhookPullRequestLockedPullRequestMergedByType?
...
public extension WebhookPullRequestLockedPullRequestMergedBy {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
extension WebhookPullRequestLockedPullRequestMergedBy {
...
public struct WebhookPullRequestLockedPullRequestMilestone: Codable {
    ...
    public var creator: WebhookPullRequestLockedPullRequestMilestoneCreator?
    ...
    public var state: WebhookPullRequestLockedPullRequestMilestoneState
...
public extension WebhookPullRequestLockedPullRequestMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestLockedPullRequestMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookPullRequestLockedPullRequestMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookPullRequestLockedPullRequestMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookPullRequestLockedPullRequestMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookPullRequestLockedPullRequestMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestLockedPullRequestMilestoneCreatorType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestLockedPullRequestMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestLockedPullRequestMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestLockedPullRequestMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestLockedPullRequestMilestoneCreator {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public enum WebhookPullRequestLockedPullRequestRequestedReviewersItem {
    case webhookPullRequestLockedPullRequestRequestedReviewersItemVariant0(
        WebhookPullRequestLockedPullRequestRequestedReviewersItemVariant0
    )
    case webhookPullRequestLockedPullRequestRequestedReviewersItemVariant1(
        WebhookPullRequestLockedPullRequestRequestedReviewersItemVariant1
    )
}
