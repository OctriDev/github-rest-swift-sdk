...
public extension WebhooksIssueMilestone {
    init(
        ...
        closedIssues: Int,
        createdAt: Date,
        creator: WebhooksIssueMilestoneCreator?,
        description: String?,
        dueOn: Date?,
        htmlUrl: String,
        id: Int,
        ...
        number: Int,
        openIssues: Int,
        state: WebhooksIssueMilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
...
public extension WebhooksIssueMilestoneCreator {
    init(
        ...
        type: WebhooksIssueMilestoneCreatorType? = nil,
        url: String? = nil,
...
public extension WebhooksIssuePerformedViaGithubApp {
    init(
        ...
        name: String,
        nodeId: String,
        owner: WebhooksIssuePerformedViaGithubAppOwner?,
        updatedAt: Date?,
        events: [WebhooksIssuePerformedViaGithubAppEventsItem]? = nil,
        permissions: WebhooksIssuePerformedViaGithubAppPermissions? = nil,
        slug: String? = nil
    ) throws {
