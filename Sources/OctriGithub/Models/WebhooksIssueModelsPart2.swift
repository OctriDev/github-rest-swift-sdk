...
public struct WebhooksIssueLabelsItem: Codable {
...
public extension WebhooksIssueLabelsItem {
...
public struct WebhooksIssueMilestone: Codable {
    ...
    public var creator: WebhooksIssueMilestoneCreator?
    /// Required `string` value serialized in the `description` wire field.
    public var description: String?
    ...
    public var state: WebhooksIssueMilestoneState
...
public extension WebhooksIssueMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhooksIssueMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhooksIssueMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhooksIssueMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhooksIssueMilestone {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhooksIssueMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    ...
    public var type: WebhooksIssueMilestoneCreatorType?
...
public extension WebhooksIssueMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
extension WebhooksIssueMilestoneCreator {
    func sdkValidateConstraints() throws {
...
public struct WebhooksIssuePerformedViaGithubApp: Codable {
    /// Required `date-time`-formatted value serialized in the `created_at` wire field.
    public var createdAt: Date?
    /// Required `string` value serialized in the `description` wire field.
    public var description: String?
    ...
    public var owner: WebhooksIssuePerformedViaGithubAppOwner?
    /// Required `date-time`-formatted value serialized in the `updated_at` wire field.
    public var updatedAt: Date?
    /// The list of events for the GitHub app
    public var events: [WebhooksIssuePerformedViaGithubAppEventsItem]?
    /// The set of permissions for the GitHub app
    public var permissions: WebhooksIssuePerformedViaGithubAppPermissions?
...
public extension WebhooksIssuePerformedViaGithubApp {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhooksIssuePerformedViaGithubApp {
    public init(createdAt: Date?, description: String?, externalUrl: String?, htmlUrl: String, id: Int?, name: String, nodeId: String, owner: WebhooksIssuePerformedViaGithubAppOwner?, updatedAt: Date?, events: [WebhooksIssuePerformedViaGithubAppEventsItem]? = nil, permissions: WebhooksIssuePerformedViaGithubAppPermissions? = nil, slug: String? = nil) throws {
...
/// Required object value serialized in the `owner` wire field.
public struct WebhooksIssuePerformedViaGithubAppOwner: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhooksIssuePerformedViaGithubAppOwnerType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
