...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepo {
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoPuXaeb012b418? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, stargazers: Int? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepo {
...
public enum WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner {
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoPermissions: Codable {
