...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPuX5d11579df1? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, stargazers: Int? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo {
...
public enum WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense: Codable {
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerType?
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner {
...
public struct WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPushedAt")
    }
