...
public struct FullRepository: Codable {
    ...
    /// Required `boolean` value serialized in the `has_discussions` wire field.
    /// - Example: true
    ...
    /// Required `integer` value serialized in the `subscribers_count` wire field.
    /// - Example: 42
    public var subscribersCount: Int
    /// Required `integer` value serialized in the `network_count` wire field.
    ...
    /// - Example: "all"
    public var pullRequestCreationPolicy: FullRepositoryPullRequestCreationPolicy?
    ...
    /// - Example: "PR_TITLE"
    public var squashMergeCommitTitle: FullRepositorySquashMergeCommitTitle?
    ...
    /// - Example: "PR_BODY"
    public var squashMergeCommitMessage: FullRepositorySquashMergeCommitMessage?
    ...
    /// branch-name).
    /// - Example: "PR_TITLE"
    public var mergeCommitTitle: FullRepositoryMergeCommitTitle?
    ...
    /// - Example: "PR_BODY"
    public var mergeCommitMessage: FullRepositoryMergeCommitMessage?
...
extension FullRepository {
    public init(from decoder: Decoder) throws {
        ...
        self.subscribersCount = try container.sdkDecodeRequired(.subscribersCount)
        self.networkCount = try container.sdkDecodeRequired(.networkCount)
