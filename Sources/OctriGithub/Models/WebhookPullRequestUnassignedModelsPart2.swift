...
public extension WebhookPullRequestUnassignedPullRequestLinksIssue {
...
public struct WebhookPullRequestUnassignedPullRequestLinksReviewComment: Codable {
...
public extension WebhookPullRequestUnassignedPullRequestLinksReviewComment {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnassignedPullRequestLinksReviewComments: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnassignedPullRequestLinksReviewComments {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnassignedPullRequestLinksSelf: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnassignedPullRequestLinksSelf {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnassignedPullRequestLinksStatuses: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnassignedPullRequestLinksStatuses {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnassignedPullRequestAssignee: Codable {
    ...
    public var type: WebhookPullRequestUnassignedPullRequestAssigneeType?
...
public extension WebhookPullRequestUnassignedPullRequestAssignee {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestUnassignedPullRequestAssignee {
...
public struct WebhookPullRequestUnassignedPullRequestAssigneesItem: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestUnassignedPullRequestAssigneesItemType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
...
public extension WebhookPullRequestUnassignedPullRequestAssigneesItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestUnassignedPullRequestAssigneesItem {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestUnassignedPullRequestAssigneesItemType? = nil, url: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestUnassignedPullRequestAssigneesItem {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestUnassignedPullRequestAutoMerge: Codable {
    /// Commit message for the merge commit.
    public var commitMessage: String?
    /// Title for the merge commit message.
    public var commitTitle: String?
    /// Required object value serialized in the `enabled_by` wire field.
    public var enabledBy: WebhookPullRequestUnassignedPullRequestAutoMergeEnabledBy?
    /// The merge method to use.
    public var mergeMethod: WebhookPullRequestUnassignedPullRequestAutoMergeMergeMethod
...
public extension WebhookPullRequestUnassignedPullRequestAutoMerge {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestUnassignedPullRequestAutoMerge {
    public init(commitMessage: String?, commitTitle: String?, enabledBy: WebhookPullRequestUnassignedPullRequestAutoMergeEnabledBy?, mergeMethod: WebhookPullRequestUnassignedPullRequestAutoMergeMergeMethod) {
