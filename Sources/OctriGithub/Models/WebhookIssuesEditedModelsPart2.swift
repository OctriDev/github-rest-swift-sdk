...
public struct WebhookIssuesEditedIssueAssigneesItem: Codable {
    ...
    public var type: WebhookIssuesEditedIssueAssigneesItemType?
...
public extension WebhookIssuesEditedIssueAssigneesItem {
...
extension WebhookIssuesEditedIssueAssigneesItem {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookIssuesEditedIssueLabelsItem: Codable {
...
public extension WebhookIssuesEditedIssueLabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookIssuesEditedIssueMilestone: Codable {
    ...
    public var creator: WebhookIssuesEditedIssueMilestoneCreator?
    /// Required `string` value serialized in the `description` wire field.
    public var description: String?
    ...
    public var state: WebhookIssuesEditedIssueMilestoneState
...
public extension WebhookIssuesEditedIssueMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookIssuesEditedIssueMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookIssuesEditedIssueMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookIssuesEditedIssueMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookIssuesEditedIssueMilestone {
    func sdkValidateConstraints() throws {
...
/// Required object value serialized in the `creator` wire field.
public struct WebhookIssuesEditedIssueMilestoneCreator: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookIssuesEditedIssueMilestoneCreatorType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
...
public extension WebhookIssuesEditedIssueMilestoneCreator {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookIssuesEditedIssueMilestoneCreator {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookIssuesEditedIssueMilestoneCreatorType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
