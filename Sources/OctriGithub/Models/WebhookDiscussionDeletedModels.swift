...
// WebhookDiscussionDeleted domain models
/// Typed representation of the `WebhookDiscussionDeleted` API schema.
public struct WebhookDiscussionDeleted: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionDeletedAction
...
public extension WebhookDiscussionDeleted {
...
public extension WebhookDiscussionDeleted {
    public init(action: WebhookDiscussionDeletedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionDeletedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let deleted = WebhookDiscussionDeletedAction(rawValue: "deleted")
