...
// WebhookMilestoneDeleted domain models
/// Typed representation of the `WebhookMilestoneDeleted` API schema.
public struct WebhookMilestoneDeleted: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookMilestoneDeletedAction
...
public extension WebhookMilestoneDeleted {
...
public extension WebhookMilestoneDeleted {
    public init(action: WebhookMilestoneDeletedAction, milestone: WebhooksMilestone, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookMilestoneDeletedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let deleted = WebhookMilestoneDeletedAction(rawValue: "deleted")
