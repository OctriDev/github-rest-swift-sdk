...
public extension WebhookPullRequestReviewEditedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestReviewEditedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewEditedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewEditedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestReviewEditedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestReviewEditedPullRequestBaseUserType?
...
public extension WebhookPullRequestReviewEditedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewEditedPullRequestBaseUser {
...
public struct WebhookPullRequestReviewEditedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestReviewEditedPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestReviewEditedPullRequestHeadUser?
...
public extension WebhookPullRequestReviewEditedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewEditedPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewEditedPullRequestHeadRepo?, sha: String, user: WebhookPullRequestReviewEditedPullRequestHeadUser?) {
