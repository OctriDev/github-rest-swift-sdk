...
public extension WebhooksPullRequest5RequestedReviewersItemVariant1 {
...
public extension WebhooksPullRequest5RequestedReviewersItemVariant1Parent {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.description = try container.sdkDecodeIfPresent(.description)
...
public extension WebhooksPullRequest5RequestedTeamsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhooksPullRequest5RequestedTeamsItemParent {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.description = try container.sdkDecodeIfPresent(.description)
        self.htmlUrl = try container.sdkDecodeRequired(.htmlUrl)
...
public extension WebhooksPullRequest5User {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
