...
/// A git repository
public struct WebhookPullRequestUnlabeledPullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestUnlabeledPullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestUnlabeledPullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestUnlabeledPullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestUnlabeledPullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestUnlabeledPullRequestHeadRepoPullRequestCreationPolicy?
    ...
    public var mergeCommitMessage: WebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitMessage?
    /// The default value for a merge commit message title.
    public var mergeCommitTitle: WebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestUnlabeledPullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestUnlabeledPullRequestHeadRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestUnlabeledPullRequestHeadRepoSquashMergeCommitTitle?
...
public extension WebhookPullRequestUnlabeledPullRequestHeadRepo {
...
public extension WebhookPullRequestUnlabeledPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestUnlabeledPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestUnlabeledPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestUnlabeledPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestUnlabeledPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestUnlabeledPullRequestHeadRepoPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestUnlabeledPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestUnlabeledPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestUnlabeledPullRequestHeadRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhookPullRequestUnlabeledPullRequestHeadRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestUnlabeledPullRequestHeadRepo {
...
public enum WebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
