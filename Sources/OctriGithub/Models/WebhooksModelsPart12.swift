...
public extension WebhooksPullRequest5BaseRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhooksPullRequest5BaseRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhooksPullRequest5BaseRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhooksPullRequest5BaseRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhooksPullRequest5BaseRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhooksPullRequest5BaseRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhooksPullRequest5BaseRepoPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhooksPullRequest5BaseRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhooksPullRequest5BaseRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhooksPullRequest5BaseRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhooksPullRequest5BaseRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhooksPullRequest5BaseRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
public enum WebhooksPullRequest5BaseRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhooksPullRequest5BaseRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhooksPullRequest5BaseRepoCreatedAt")
    }
...
public struct WebhooksPullRequest5BaseRepoLicense: Codable {
...
public extension WebhooksPullRequest5BaseRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhooksPullRequest5BaseRepoOwner: Codable {
    ...
    public var type: WebhooksPullRequest5BaseRepoOwnerType?
...
public extension WebhooksPullRequest5BaseRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhooksPullRequest5BaseRepoOwner {
...
public struct WebhooksPullRequest5BaseRepoPermissions: Codable {
...
public extension WebhooksPullRequest5BaseRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhooksPullRequest5BaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhooksPullRequest5BaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhooksPullRequest5BaseRepoPushedAt")
    }
