...
public struct WebhookPullRequestAssignedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestAssignedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestAssignedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestAssignedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestAssignedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestAssignedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestAssignedPullRequestBaseUserType?
...
public extension WebhookPullRequestAssignedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestAssignedPullRequestBaseUser {
...
public struct WebhookPullRequestAssignedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String?
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestAssignedPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestAssignedPullRequestHeadUser?
...
public extension WebhookPullRequestAssignedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestAssignedPullRequestHead {
    public init(label: String?, ref: String, repo: WebhookPullRequestAssignedPullRequestHeadRepo?, sha: String, user: WebhookPullRequestAssignedPullRequestHeadUser?) {
