...
// WebhookRepositoryUnarchived domain models
/// Typed representation of the `WebhookRepositoryUnarchived` API schema.
public struct WebhookRepositoryUnarchived: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryUnarchivedAction
...
public extension WebhookRepositoryUnarchived {
...
public extension WebhookRepositoryUnarchived {
    public init(action: WebhookRepositoryUnarchivedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryUnarchivedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let unarchived = WebhookRepositoryUnarchivedAction(rawValue: "unarchived")
