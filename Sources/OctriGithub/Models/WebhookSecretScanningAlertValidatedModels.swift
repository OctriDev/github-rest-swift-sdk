...
// WebhookSecretScanningAlertValidated domain models
/// Typed representation of the `WebhookSecretScanningAlertValidated` API schema.
public struct WebhookSecretScanningAlertValidated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertValidatedAction
...
public extension WebhookSecretScanningAlertValidated {
...
public extension WebhookSecretScanningAlertValidated {
    public init(action: WebhookSecretScanningAlertValidatedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertValidatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let validated = WebhookSecretScanningAlertValidatedAction(rawValue: "validated")
