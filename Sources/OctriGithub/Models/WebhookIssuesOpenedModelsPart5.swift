...
public extension WebhookIssuesOpenedChangesOldRepository {
...
public extension WebhookIssuesOpenedChangesOldRepository {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookIssuesOpenedChangesOldRepositoryCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookIssuesOpenedChangesOldRepositoryLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookIssuesOpenedChangesOldRepositoryOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookIssuesOpenedChangesOldRepositoryPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookIssuesOpenedChangesOldRepositoryVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, customProperties: [String: JSONValue]? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasDiscussions: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookIssuesOpenedChangesOldRepositoryPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, organization: String? = nil, permissions: WebhookIssuesOpenedChangesOldRepositoryPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, stargazers: Int? = nil, webCommitSignoffRequired: Bool? = nil) throws {
        ...
        (self.disabled, self.hasDiscussions) = (disabled, hasDiscussions)
...
extension WebhookIssuesOpenedChangesOldRepository {
...
public enum WebhookIssuesOpenedChangesOldRepositoryCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookIssuesOpenedChangesOldRepositoryCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookIssuesOpenedChangesOldRepositoryCreatedAt")
    }
...
public struct WebhookIssuesOpenedChangesOldRepositoryLicense: Codable {
...
public extension WebhookIssuesOpenedChangesOldRepositoryLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookIssuesOpenedChangesOldRepositoryOwner: Codable {
    ...
    public var type: WebhookIssuesOpenedChangesOldRepositoryOwnerType?
...
public extension WebhookIssuesOpenedChangesOldRepositoryOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssuesOpenedChangesOldRepositoryOwner {
...
public struct WebhookIssuesOpenedChangesOldRepositoryPermissions: Codable {
