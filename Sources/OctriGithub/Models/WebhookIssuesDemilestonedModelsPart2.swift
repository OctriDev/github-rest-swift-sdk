...
public extension WebhookIssuesDemilestonedIssueAssigneesItem {
    init(
        ...
        type: WebhookIssuesDemilestonedIssueAssigneesItemType? = nil,
        url: String? = nil
    ) throws {
...
public extension WebhookIssuesDemilestonedIssueMilestone {
    init(
        ...
        number: Int,
        openIssues: Int,
        state: WebhookIssuesDemilestonedIssueMilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
...
public extension WebhookIssuesDemilestonedIssueMilestoneCreator {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookIssuesDemilestonedIssueMilestoneCreatorType? = nil,
        url: String? = nil,
...
public typealias WebhookIssuesDemilestonedIssuePerformedViaGithubAppEventsList =
    [WebhookIssuesDemilestonedIssuePerformedViaGithubAppEventsItem]
