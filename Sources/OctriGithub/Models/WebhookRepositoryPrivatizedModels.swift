...
// WebhookRepositoryPrivatized domain models
/// Typed representation of the `WebhookRepositoryPrivatized` API schema.
public struct WebhookRepositoryPrivatized: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryPrivatizedAction
...
public extension WebhookRepositoryPrivatized {
...
public extension WebhookRepositoryPrivatized {
    public init(action: WebhookRepositoryPrivatizedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryPrivatizedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let privatized = WebhookRepositoryPrivatizedAction(rawValue: "privatized")
