...
// WebhookLabelUnarchived domain models
/// Typed representation of the `WebhookLabelUnarchived` API schema.
public struct WebhookLabelUnarchived: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookLabelUnarchivedAction
    /// Required API value serialized in the `label` wire field.
    public var label: WebhooksLabelUnarchived
...
public extension WebhookLabelUnarchived {
...
public extension WebhookLabelUnarchived {
    public init(action: WebhookLabelUnarchivedAction, label: WebhooksLabelUnarchived, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookLabelUnarchivedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let unarchived = WebhookLabelUnarchivedAction(rawValue: "unarchived")
