...
// WebhookPullRequestConvertedToDraft domain models
/// Typed representation of the `WebhookPullRequestConvertedToDraft` API schema.
public struct WebhookPullRequestConvertedToDraft: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookPullRequestConvertedToDraftAction
...
public extension WebhookPullRequestConvertedToDraft {
...
public extension WebhookPullRequestConvertedToDraft {
    public init(action: WebhookPullRequestConvertedToDraftAction, number: WebhooksNumber, pullRequest: PullRequestWebhook, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPullRequestConvertedToDraftAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let convertedToDraft = WebhookPullRequestConvertedToDraftAction(rawValue: "converted_to_draft")
