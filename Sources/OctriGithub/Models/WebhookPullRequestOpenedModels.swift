...
// WebhookPullRequestOpened domain models
/// Typed representation of the `WebhookPullRequestOpened` API schema.
public struct WebhookPullRequestOpened: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookPullRequestOpenedAction
...
public extension WebhookPullRequestOpened {
...
public extension WebhookPullRequestOpened {
    public init(action: WebhookPullRequestOpenedAction, number: WebhooksNumber, pullRequest: PullRequestWebhook, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPullRequestOpenedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let opened = WebhookPullRequestOpenedAction(rawValue: "opened")
