...
// WebhookDependabotAlertFixed domain models
/// Typed representation of the `WebhookDependabotAlertFixed` API schema.
public struct WebhookDependabotAlertFixed: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDependabotAlertFixedAction
    /// A Dependabot alert.
...
public extension WebhookDependabotAlertFixed {
...
public extension WebhookDependabotAlertFixed {
    public init(action: WebhookDependabotAlertFixedAction, alert: DependabotAlert, repository: RepositoryWebhooks, sender: SimpleUser, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, enterprise: EnterpriseWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDependabotAlertFixedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let fixed = WebhookDependabotAlertFixedAction(rawValue: "fixed")
