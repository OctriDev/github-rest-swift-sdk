...
public struct WebhookPullRequestStackedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestStackedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestStackedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestStackedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestStackedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestStackedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestStackedPullRequestBaseUserType?
...
public extension WebhookPullRequestStackedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestStackedPullRequestBaseUser {
...
public struct WebhookPullRequestStackedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String?
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestStackedPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestStackedPullRequestHeadUser?
...
public extension WebhookPullRequestStackedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestStackedPullRequestHead {
    public init(label: String?, ref: String, repo: WebhookPullRequestStackedPullRequestHeadRepo?, sha: String, user: WebhookPullRequestStackedPullRequestHeadUser?) {
