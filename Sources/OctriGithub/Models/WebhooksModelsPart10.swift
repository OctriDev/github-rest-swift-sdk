...
public struct WebhooksPullRequest5LinksStatuses: Codable {
...
public extension WebhooksPullRequest5LinksStatuses {
...
public struct WebhooksPullRequest5Assignee: Codable {
    ...
    public var type: WebhooksPullRequest5AssigneeType?
...
public extension WebhooksPullRequest5Assignee {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhooksPullRequest5Assignee {
...
public struct WebhooksPullRequest5AssigneesItem: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhooksPullRequest5AssigneesItemType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
...
public extension WebhooksPullRequest5AssigneesItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhooksPullRequest5AssigneesItem {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhooksPullRequest5AssigneesItemType? = nil, url: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhooksPullRequest5AssigneesItem {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhooksPullRequest5AutoMerge: Codable {
    /// Commit message for the merge commit.
    public var commitMessage: String?
    /// Title for the merge commit message.
    public var commitTitle: String?
    /// Required object value serialized in the `enabled_by` wire field.
    public var enabledBy: WebhooksPullRequest5AutoMergeEnabledBy?
    /// The merge method to use.
    public var mergeMethod: WebhooksPullRequest5AutoMergeMergeMethod
...
public extension WebhooksPullRequest5AutoMerge {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhooksPullRequest5AutoMerge {
    public init(commitMessage: String?, commitTitle: String?, enabledBy: WebhooksPullRequest5AutoMergeEnabledBy?, mergeMethod: WebhooksPullRequest5AutoMergeMergeMethod) {
...
/// Required object value serialized in the `enabled_by` wire field.
public struct WebhooksPullRequest5AutoMergeEnabledBy: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhooksPullRequest5AutoMergeEnabledByType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
