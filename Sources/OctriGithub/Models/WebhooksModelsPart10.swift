...
public extension WebhooksPullRequest5Assignee {
    init(
        ...
        type: WebhooksPullRequest5AssigneeType? = nil,
        url: String? = nil,
...
public extension WebhooksPullRequest5AssigneesItem {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhooksPullRequest5AssigneesItemType? = nil,
        url: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
...
public extension WebhooksPullRequest5AutoMerge {
    init(
        ...
        commitTitle: String?,
        enabledBy: WebhooksPullRequest5AutoMergeEnabledBy?,
        mergeMethod: WebhooksPullRequest5AutoMergeMergeMethod
    ) {
