...
public extension WebhookIssueCommentDeletedIssueVariant0Assignee {
    init(
        ...
        type: WebhookIssueCommentDeletedIssueVariant0AssigneeType? = nil,
        url: String? = nil,
...
public extension WebhookIssueCommentDeletedIssueVariant0AssigneesItem {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookIssueCommentDeletedIssueVariant0AssigneesItemType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
...
public extension WebhookIssueCommentDeletedIssueVariant0Milestone {
    init(
        ...
        closedIssues: Int,
        createdAt: Date,
        creator: WebhookIssueCommentDeletedIssueVariant0MilestoneCreator?,
        description: String?,
        dueOn: Date?,
        htmlUrl: String,
        id: Int,
        ...
        number: Int,
        openIssues: Int,
        state: WebhookIssueCommentDeletedIssueVariant0MilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
