...
public struct WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestAutoMergeDisabledPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestAutoMergeDisabledPullRequestBaseUserType?
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestAutoMergeDisabledPullRequestBaseUser {
...
public struct WebhookPullRequestAutoMergeDisabledPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestAutoMergeDisabledPullRequestHeadUser?
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo, sha: String, user: WebhookPullRequestAutoMergeDisabledPullRequestHeadUser?) {
