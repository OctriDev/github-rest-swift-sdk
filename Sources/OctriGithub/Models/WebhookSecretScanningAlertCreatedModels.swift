...
// WebhookSecretScanningAlertCreated domain models
/// Typed representation of the `WebhookSecretScanningAlertCreated` API schema.
public struct WebhookSecretScanningAlertCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookSecretScanningAlertCreatedAction
...
public extension WebhookSecretScanningAlertCreated {
...
public extension WebhookSecretScanningAlertCreated {
    public init(action: WebhookSecretScanningAlertCreatedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookSecretScanningAlertCreatedAction(rawValue: "created")
