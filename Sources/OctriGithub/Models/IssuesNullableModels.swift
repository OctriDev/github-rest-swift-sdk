...
public extension NullableIssue {
    init(
        ...
        labels: [NullableIssueLabelsItem],
        ...
        createdAt: Date,
        updatedAt: Date,
        stateReason: NullableIssueStateReason? = nil,
        body: String? = nil,
        assignees: [SimpleUser]? = nil,
        activeLockReason: String? = nil,
        pullRequest: NullableIssuePullRequest? = nil,
        draft: Bool? = nil,
...
extension NullableIssueLabelsItem: Codable {
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(
            in: container,
            debugDescription: "No variant matched for NullableIssueLabelsItem"
        )
    }
    ...
    private static func decodeGroup1(from container: SingleValueDecodingContainer) -> Self? {
        ...
        if let value = try? container
            .decode(NullableIssueLabelsItemVariant1.self) {
            return .nullableIssueLabelsItemVariant1(value)
        }
        return nil
    }
...
public extension NullableIssueLabelsItemVariant1 {
    init(
        ...
        color: String? = nil,
        default: Bool? = nil,
        archivedBy: NullableIssueLabelsItemVariant1ArchivedBy? = nil
    ) throws {
        self.init()
        (self.id, self.nodeId) = (id, nodeId)
