...
public extension WebhookCheckSuiteRequested {
    init(
        action: WebhookCheckSuiteRequestedAction,
        checkSuite: WebhookCheckSuiteRequestedCheckSuite,
...
public extension WebhookCheckSuiteRequestedCheckSuite {
    init(
        after: String?,
        app: WebhookCheckSuiteRequestedCheckSuiteApp,
        before: String?,
        checkRunsUrl: String,
        conclusion: WebhookCheckSuiteRequestedCheckSuiteConclusion?,
        createdAt: Date,
        headBranch: String?,
        headCommit: WebhookCheckSuiteRequestedCheckSuiteHeadCommit,
        headSha: String,
        id: Int,
        latestCheckRunsCount: Int,
        nodeId: String,
        pullRequests: [WebhookCheckSuiteRequestedCheckSuitePullRequestsItem],
        status: WebhookCheckSuiteRequestedCheckSuiteStatus?,
        updatedAt: Date,
        url: String,
...
public extension WebhookCheckSuiteRequestedCheckSuiteApp {
    init(
        ...
        name: String,
        nodeId: String,
        owner: WebhookCheckSuiteRequestedCheckSuiteAppOwner?,
        updatedAt: Date?,
        events: [WebhookCheckSuiteRequestedCheckSuiteAppEventsItem]? = nil,
        clientId: String? = nil,
        permissions: WebhookCheckSuiteRequestedCheckSuiteAppPermissions? = nil,
        slug: String? = nil
    ) throws {
...
public extension WebhookCheckSuiteRequestedCheckSuiteAppOwner {
    init(
        ...
        type: WebhookCheckSuiteRequestedCheckSuiteAppOwnerType? = nil,
        url: String? = nil,
