...
public extension WebhookCheckSuiteRequested {
...
public extension WebhookCheckSuiteRequestedCheckSuite {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookCheckSuiteRequestedCheckSuiteApp {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookCheckSuiteRequestedCheckSuiteAppOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
