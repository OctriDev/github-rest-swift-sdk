...
// WebhookMemberRemoved domain models
/// Typed representation of the `WebhookMemberRemoved` API schema.
public struct WebhookMemberRemoved: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookMemberRemovedAction
...
public extension WebhookMemberRemoved {
...
public extension WebhookMemberRemoved {
    public init(action: WebhookMemberRemovedAction, member: WebhooksUser?, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookMemberRemovedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let removed = WebhookMemberRemovedAction(rawValue: "removed")
