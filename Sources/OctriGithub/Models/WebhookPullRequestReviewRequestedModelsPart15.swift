...
extension WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoLicense {
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestLabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
