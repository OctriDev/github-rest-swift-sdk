...
public extension WebhookPullRequestReviewEditedPullRequestBaseRepo {
...
public extension WebhookPullRequestReviewEditedPullRequestBaseRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewEditedPullRequestBaseRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewEditedPullRequestBaseRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewEditedPullRequestBaseRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewEditedPullRequestBaseRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewEditedPullRequestBaseRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, stargazers: Int? = nil) throws {
...
extension WebhookPullRequestReviewEditedPullRequestBaseRepo {
...
public enum WebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewEditedPullRequestBaseRepoCreatedAt")
    }
...
public struct WebhookPullRequestReviewEditedPullRequestBaseRepoLicense: Codable {
...
public extension WebhookPullRequestReviewEditedPullRequestBaseRepoLicense {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookPullRequestReviewEditedPullRequestBaseRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestReviewEditedPullRequestBaseRepoOwnerType?
...
public extension WebhookPullRequestReviewEditedPullRequestBaseRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewEditedPullRequestBaseRepoOwner {
...
public struct WebhookPullRequestReviewEditedPullRequestBaseRepoPermissions: Codable {
