...
public extension WebhookIssuesDeletedIssueAssigneesItem {
    init(
        ...
        type: WebhookIssuesDeletedIssueAssigneesItemType? = nil,
        url: String? = nil,
...
public extension WebhookIssuesDeletedIssueMilestone {
    init(
        ...
        number: Int,
        openIssues: Int,
        state: WebhookIssuesDeletedIssueMilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
...
public extension WebhookIssuesDeletedIssueMilestoneCreator {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookIssuesDeletedIssueMilestoneCreatorType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
