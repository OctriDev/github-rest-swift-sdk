...
public struct WebhookPullRequestSynchronizePullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestSynchronizePullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestSynchronizePullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestSynchronizePullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestSynchronizePullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestSynchronizePullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestSynchronizePullRequestBaseUserType?
...
public extension WebhookPullRequestSynchronizePullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestSynchronizePullRequestBaseUser {
...
public struct WebhookPullRequestSynchronizePullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestSynchronizePullRequestHeadRepo
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestSynchronizePullRequestHeadUser?
...
public extension WebhookPullRequestSynchronizePullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestSynchronizePullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestSynchronizePullRequestHeadRepo, sha: String, user: WebhookPullRequestSynchronizePullRequestHeadUser?) {
