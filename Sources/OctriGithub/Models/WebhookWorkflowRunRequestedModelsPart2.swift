...
public extension WebhookWorkflowRunRequestedWorkflowRunHeadCommit {
    public init(author: WebhookWorkflowRunRequestedWorkflowRunHeadCommitAuthor, committer: WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter, id: String, message: String, timestamp: String, treeId: String) {
...
public struct WebhookWorkflowRunRequestedWorkflowRunHeadCommitAuthor: Codable {
...
public extension WebhookWorkflowRunRequestedWorkflowRunHeadCommitAuthor {
...
/// Metaproperties for Git author/committer information.
public struct WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter: Codable {
    /// Required `email`-formatted value serialized in the `email` wire field.
    public var email: String?
    /// The git author's name.
    public var name: String
...
public extension WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.email) else {
            throw SdkValidationError(field: "email", code: "required", message: "Validation failed for 'email': value is required")
...
public struct WebhookWorkflowRunRequestedWorkflowRunHeadRepository: Codable {
    ...
    public var owner: WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner?
...
public extension WebhookWorkflowRunRequestedWorkflowRunHeadRepository {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookWorkflowRunRequestedWorkflowRunHeadRepository {
...
/// Required object value serialized in the `owner` wire field.
public struct WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner: Codable {
    ...
    public var type: WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType?
...
public extension WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
