...
extension WebhookCodeScanningAlertFixed {
...
extension WebhookCodeScanningAlertFixedAlert {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookCodeScanningAlertFixedAlertMostRecentInstance {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookCodeScanningAlertFixedAlertMostRecentInstanceLocation {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookCodeScanningAlertFixedAlertMostRecentInstanceMessage {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
