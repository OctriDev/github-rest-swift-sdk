...
// WebhookDiscussionLabeled domain models
/// Typed representation of the `WebhookDiscussionLabeled` API schema.
public struct WebhookDiscussionLabeled: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionLabeledAction
...
public extension WebhookDiscussionLabeled {
...
public extension WebhookDiscussionLabeled {
    public init(action: WebhookDiscussionLabeledAction, discussion: Discussion, label: WebhooksLabel, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionLabeledAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let labeled = WebhookDiscussionLabeledAction(rawValue: "labeled")
