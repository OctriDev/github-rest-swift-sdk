...
// WebhookRepositoryCreated domain models
/// Typed representation of the `WebhookRepositoryCreated` API schema.
public struct WebhookRepositoryCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryCreatedAction
...
public extension WebhookRepositoryCreated {
...
public extension WebhookRepositoryCreated {
    public init(action: WebhookRepositoryCreatedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookRepositoryCreatedAction(rawValue: "created")
