...
public extension WebhookDependabotAlertAutoDismissed {
    public init(action: WebhookDependabotAlertAutoDismissedAction, alert: DependabotAlert, repository: RepositoryWebhooks, sender: SimpleUser, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, enterprise: EnterpriseWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDependabotAlertAutoDismissedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
