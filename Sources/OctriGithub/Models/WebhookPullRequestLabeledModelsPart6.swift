...
/// A git repository
public struct WebhookPullRequestLabeledPullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestLabeledPullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestLabeledPullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestLabeledPullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestLabeledPullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestLabeledPullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestLabeledPullRequestHeadRepoPullRequestCreationPolicy?
    ...
    public var mergeCommitMessage: WebhookPullRequestLabeledPullRequestHeadRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestLabeledPullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestLabeledPullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestLabeledPullRequestHeadRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestLabeledPullRequestHeadRepoSquashMergeCommitTitle?
...
public extension WebhookPullRequestLabeledPullRequestHeadRepo {
...
public extension WebhookPullRequestLabeledPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestLabeledPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestLabeledPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestLabeledPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestLabeledPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestLabeledPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestLabeledPullRequestHeadRepoPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestLabeledPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestLabeledPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestLabeledPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestLabeledPullRequestHeadRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhookPullRequestLabeledPullRequestHeadRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestLabeledPullRequestHeadRepo {
...
public enum WebhookPullRequestLabeledPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
