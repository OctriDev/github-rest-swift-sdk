...
extension WebhookIssueCommentUnpinnedIssueVariant1AssigneesItem {
    public init() {
    }
}
...
extension WebhookIssueCommentUnpinnedIssueVariant1LabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentUnpinnedIssueVariant1Milestone {
    public init() {
    }
}
...
extension WebhookIssueCommentUnpinnedIssueVariant1PerformedViaGithubApp {
    public init() {
    }
}
...
extension WebhookIssueCommentUnpinnedIssueVariant1Reactions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentUnpinnedIssueVariant1User {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.avatarUrl = try container.sdkDecodeIfPresent(.avatarUrl)
        self.eventsUrl = try container.sdkDecodeIfPresent(.eventsUrl)
