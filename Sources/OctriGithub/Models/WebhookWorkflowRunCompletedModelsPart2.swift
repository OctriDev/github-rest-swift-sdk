...
public extension WebhookWorkflowRunCompletedWorkflowRunHeadCommit {
    init(
        author: WebhookWorkflowRunCompletedWorkflowRunHeadCommitAuthor,
        committer: WebhookWorkflowRunCompletedWorkflowRunHeadCommitCommitter,
        id: String,
        message: String,
        timestamp: String,
        treeId: String
...
public extension WebhookWorkflowRunCompletedWorkflowRunHeadRepository {
    init(
        ...
        owner: WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner?,
        private: Bool,
        pullsUrl: String,
        releasesUrl: String,
