...
// WebhookDiscussionReopened domain models
/// Typed representation of the `WebhookDiscussionReopened` API schema.
public struct WebhookDiscussionReopened: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionReopenedAction
...
public extension WebhookDiscussionReopened {
...
public extension WebhookDiscussionReopened {
    public init(action: WebhookDiscussionReopenedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionReopenedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let reopened = WebhookDiscussionReopenedAction(rawValue: "reopened")
