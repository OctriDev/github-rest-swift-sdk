...
public struct WebhookPullRequestEnqueuedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestEnqueuedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestEnqueuedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestEnqueuedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestEnqueuedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestEnqueuedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestEnqueuedPullRequestBaseUserType?
...
public extension WebhookPullRequestEnqueuedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestEnqueuedPullRequestBaseUser {
...
public struct WebhookPullRequestEnqueuedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestEnqueuedPullRequestHeadRepo
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestEnqueuedPullRequestHeadUser?
...
public extension WebhookPullRequestEnqueuedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestEnqueuedPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestEnqueuedPullRequestHeadRepo, sha: String, user: WebhookPullRequestEnqueuedPullRequestHeadUser?) {
