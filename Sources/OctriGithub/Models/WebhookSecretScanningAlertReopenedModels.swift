...
public extension WebhookSecretScanningAlertReopened {
    public init(action: WebhookSecretScanningAlertReopenedAction, alert: SecretScanningAlertWebhook, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookSecretScanningAlertReopenedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
