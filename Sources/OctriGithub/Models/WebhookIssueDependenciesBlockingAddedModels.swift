...
public extension WebhookIssueDependenciesBlockingAdded {
    init(
        action: WebhookIssueDependenciesBlockingAddedAction,
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookIssueDependenciesBlockingAddedAction: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
