...
public extension WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewThreadResolvedPullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewThreadResolvedPullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewThreadResolvedPullRequestBaseUser?
    ) {
