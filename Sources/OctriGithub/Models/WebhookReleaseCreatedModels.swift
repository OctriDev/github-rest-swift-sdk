...
// WebhookReleaseCreated domain models
/// Typed representation of the `WebhookReleaseCreated` API schema.
public struct WebhookReleaseCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookReleaseCreatedAction
    /// The release object.
...
public extension WebhookReleaseCreated {
...
public extension WebhookReleaseCreated {
    public init(action: WebhookReleaseCreatedAction, release: WebhooksRelease, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookReleaseCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookReleaseCreatedAction(rawValue: "created")
