...
// WebhookLabelArchived domain models
/// Typed representation of the `WebhookLabelArchived` API schema.
public struct WebhookLabelArchived: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookLabelArchivedAction
    /// Required API value serialized in the `label` wire field.
    public var label: WebhooksLabelArchived
...
public extension WebhookLabelArchived {
...
public extension WebhookLabelArchived {
    public init(action: WebhookLabelArchivedAction, label: WebhooksLabelArchived, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookLabelArchivedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let archived = WebhookLabelArchivedAction(rawValue: "archived")
