...
public extension WebhookPullRequestMilestoned {
    public init(action: WebhookPullRequestMilestonedAction, number: WebhooksNumber, pullRequest: WebhooksPullRequest5, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, milestone: Milestone? = nil, organization: OrganizationSimpleWebhooks? = nil) {
