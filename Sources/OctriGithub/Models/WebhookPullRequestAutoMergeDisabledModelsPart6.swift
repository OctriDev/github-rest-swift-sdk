...
/// A git repository
public struct WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPullReqX99ed4c9150?
    ...
    public var mergeCommitMessage: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoSquashMX5d02620548?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoSquashMX4189a5dc87?
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo {
...
public extension WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPullReqX99ed4c9150? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoSquashMX5d02620548? = nil, squashMergeCommitTitle: WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoSquashMX4189a5dc87? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo {
...
public enum WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
