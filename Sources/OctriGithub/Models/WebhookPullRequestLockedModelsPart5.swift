...
public struct WebhookPullRequestLockedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestLockedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestLockedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestLockedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestLockedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestLockedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestLockedPullRequestBaseUserType?
...
public extension WebhookPullRequestLockedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestLockedPullRequestBaseUser {
...
public struct WebhookPullRequestLockedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String?
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestLockedPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestLockedPullRequestHeadUser?
...
public extension WebhookPullRequestLockedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestLockedPullRequestHead {
    public init(label: String?, ref: String, repo: WebhookPullRequestLockedPullRequestHeadRepo?, sha: String, user: WebhookPullRequestLockedPullRequestHeadUser?) {
