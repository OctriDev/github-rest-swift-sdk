...
extension WebhookIssueCommentDeletedIssueVariant1 {
...
extension WebhookIssueCommentDeletedIssueVariant1AssigneesItem {
    public init() {
    }
}
...
extension WebhookIssueCommentDeletedIssueVariant1LabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentDeletedIssueVariant1Milestone {
    public init() {
    }
}
...
extension WebhookIssueCommentDeletedIssueVariant1PerformedViaGithubApp {
    public init() {
    }
}
...
extension WebhookIssueCommentDeletedIssueVariant1Reactions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookIssueCommentDeletedIssueVariant1User {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.avatarUrl = try container.sdkDecodeIfPresent(.avatarUrl)
        self.eventsUrl = try container.sdkDecodeIfPresent(.eventsUrl)
