...
public extension WebhookIssueCommentDeletedIssueVariant1 {
    public init(assignee: WebhookIssueCommentDeletedIssueVariant1Assignee?, labels: [WebhookIssueCommentDeletedIssueVariant1LabelsItem], locked: Bool, state: WebhookIssueCommentDeletedIssueVariant1State, activeLockReason: String? = nil, assignees: [[String: JSONValue]?]? = nil, authorAssociation: String? = nil, body: String? = nil, closedAt: String? = nil, comments: Int? = nil, commentsUrl: String? = nil, createdAt: String? = nil, eventsUrl: String? = nil, htmlUrl: String? = nil, id: Int? = nil, labelsUrl: String? = nil, milestone: [String: JSONValue]? = nil, nodeId: String? = nil, number: Int? = nil, performedViaGithubApp: [String: JSONValue]? = nil, reactions: WebhookIssueCommentDeletedIssueVariant1Reactions? = nil, repositoryUrl: String? = nil, timelineUrl: String? = nil, title: String? = nil, updatedAt: String? = nil, url: String? = nil, user: WebhookIssueCommentDeletedIssueVariant1User? = nil) {
