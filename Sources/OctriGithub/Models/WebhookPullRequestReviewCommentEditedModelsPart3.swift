...
public extension WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy {
...
extension WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy {
...
public extension WebhookPullRequestReviewCommentEditedPullRequestBase {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewCommentEditedPullRequestBase {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewCommentEditedPullRequestBaseRepo, sha: String, user: WebhookPullRequestReviewCommentEditedPullRequestBaseUser?) {
...
/// A git repository
public struct WebhookPullRequestReviewCommentEditedPullRequestBaseRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoCreatedAt
    ...
    public var license: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoLicense?
    ...
    public var owner: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoPullRX44e5355846?
    ...
    public var mergeCommitMessage: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoMergeXb4325773ba?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoSquasXdd22fe6c63?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestReviewCommentEditedPullRequestBaseRepoSquasX716908b9d6?
...
public extension WebhookPullRequestReviewCommentEditedPullRequestBaseRepo {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
