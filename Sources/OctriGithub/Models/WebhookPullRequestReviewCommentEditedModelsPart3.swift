...
public extension WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledByType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewCommentEditedPullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewCommentEditedPullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewCommentEditedPullRequestBaseUser?
    ) {
