...
extension WebhookTeamDeletedRepositoryCreatedAt: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookTeamDeletedRepositoryCreatedAt")
    }
...
extension WebhookTeamDeletedRepositoryPushedAt: Codable {
    ...
    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookTeamDeletedRepositoryPushedAt")
    }
...
public struct WebhookTeamDeletedRepositoryVisibility: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String
