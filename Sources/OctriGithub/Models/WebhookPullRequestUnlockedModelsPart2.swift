...
public struct WebhookPullRequestUnlockedPullRequestLinksReviewComment: Codable {
...
public extension WebhookPullRequestUnlockedPullRequestLinksReviewComment {
...
public struct WebhookPullRequestUnlockedPullRequestLinksReviewComments: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnlockedPullRequestLinksReviewComments {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnlockedPullRequestLinksSelf: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnlockedPullRequestLinksSelf {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnlockedPullRequestLinksStatuses: Codable {
    /// Required `uri-template`-formatted value serialized in the `href` wire field.
    public var href: String
...
public extension WebhookPullRequestUnlockedPullRequestLinksStatuses {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.href) else {
            throw SdkValidationError(field: "href", code: "required", message: "Validation failed for 'href': value is required")
...
public struct WebhookPullRequestUnlockedPullRequestAssignee: Codable {
    ...
    public var type: WebhookPullRequestUnlockedPullRequestAssigneeType?
...
public extension WebhookPullRequestUnlockedPullRequestAssignee {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestUnlockedPullRequestAssignee {
...
public struct WebhookPullRequestUnlockedPullRequestAssigneesItem: Codable {
    /// Required `integer` value serialized in the `id` wire field.
    public var id: Int
    /// Required `string` value serialized in the `login` wire field.
    public var login: String
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestUnlockedPullRequestAssigneesItemType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
...
public extension WebhookPullRequestUnlockedPullRequestAssigneesItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestUnlockedPullRequestAssigneesItem {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestUnlockedPullRequestAssigneesItemType? = nil, url: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestUnlockedPullRequestAssigneesItem {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestUnlockedPullRequestAutoMerge: Codable {
    /// Commit message for the merge commit.
    public var commitMessage: String?
    /// Title for the merge commit message.
    public var commitTitle: String
    /// Required object value serialized in the `enabled_by` wire field.
    public var enabledBy: WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy?
    /// The merge method to use.
    public var mergeMethod: WebhookPullRequestUnlockedPullRequestAutoMergeMergeMethod
...
public extension WebhookPullRequestUnlockedPullRequestAutoMerge {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestUnlockedPullRequestAutoMerge {
    public init(commitMessage: String?, commitTitle: String, enabledBy: WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy?, mergeMethod: WebhookPullRequestUnlockedPullRequestAutoMergeMergeMethod) {
