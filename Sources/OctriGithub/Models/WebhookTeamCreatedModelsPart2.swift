...
public enum WebhookTeamCreatedRepositoryCreatedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookTeamCreatedRepositoryCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookTeamCreatedRepositoryCreatedAt")
    }
...
public struct WebhookTeamCreatedRepositoryLicense: Codable {
...
public extension WebhookTeamCreatedRepositoryLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookTeamCreatedRepositoryOwner: Codable {
    ...
    public var type: WebhookTeamCreatedRepositoryOwnerType?
...
public extension WebhookTeamCreatedRepositoryOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookTeamCreatedRepositoryOwner {
...
public struct WebhookTeamCreatedRepositoryPermissions: Codable {
...
public extension WebhookTeamCreatedRepositoryPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookTeamCreatedRepositoryPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookTeamCreatedRepositoryPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookTeamCreatedRepositoryPushedAt")
    }
...
public struct WebhookTeamCreatedRepositoryVisibility: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let `public` = WebhookTeamCreatedRepositoryVisibility(rawValue: "public")
    public static let `private` = WebhookTeamCreatedRepositoryVisibility(rawValue: "private")
    public static let `internal` = WebhookTeamCreatedRepositoryVisibility(rawValue: "internal")
...
/// Optional enumerated value serialized in the `type` wire field.
public struct WebhookTeamCreatedRepositoryOwnerType: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let bot = WebhookTeamCreatedRepositoryOwnerType(rawValue: "Bot")
    public static let user = WebhookTeamCreatedRepositoryOwnerType(rawValue: "User")
    public static let organization = WebhookTeamCreatedRepositoryOwnerType(rawValue: "Organization")
...
public struct WebhookTeamCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookTeamCreatedAction(rawValue: "created")
