...
public extension WebhookIssueCommentPinnedIssueVariant0PerformedViaGithubAppPermissions {
...
public extension WebhookIssueCommentPinnedIssueVariant0PullRequest {
...
public extension WebhookIssueCommentPinnedIssueVariant0Reactions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookIssueCommentPinnedIssueVariant0User {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookIssueCommentPinnedIssueVariant1 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
