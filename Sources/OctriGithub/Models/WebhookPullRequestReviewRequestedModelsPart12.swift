...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBase {
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBase {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo, sha: String, user: WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser?) {
...
/// A git repository
public struct WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt
    ...
    /// License
    public var license: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense?
    ...
    /// User
    public var owner: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner?
    /// Whether the repository is private or public.
    public var `private`: Bool
    public var pullsUrl: String
    public var pushedAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPXa846f59197?
    ...
    public var mergeCommitMessage: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMXcb008ead53?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMX4db642faf8?
    public var organization: String?
    public var permissions: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSXc13ab873e4?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSXe0e2e65095?
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPXa846f59197? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMXcb008ead53? = nil, mergeCommitTitle: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMX4db642faf8? = nil, organization: String? = nil, permissions: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSXc13ab873e4? = nil, squashMergeCommitTitle: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSXe0e2e65095? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo {
...
public enum WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
