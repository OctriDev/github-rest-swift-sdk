...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestHeadUser {
    init(
        ...
        type: WebhookPullRequestReviewRequestedVariant0PullRequestHeadUserType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMergedBy {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookPullRequestReviewRequestedVariant0PullRequestMergedByType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
        (self.id, self.login) = (id, login)
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMilestone {
    init(
        ...
        closedIssues: Int,
        createdAt: Date,
        creator: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneCreator?,
        description: String?,
        dueOn: Date?,
        htmlUrl: String,
        id: Int,
        ...
        number: Int,
        openIssues: Int,
        state: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneState,
        title: String,
        updatedAt: Date,
        url: String
    ) throws {
