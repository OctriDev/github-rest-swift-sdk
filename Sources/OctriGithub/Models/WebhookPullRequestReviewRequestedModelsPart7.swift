...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestHeadUser {
...
extension WebhookPullRequestReviewRequestedVariant0PullRequestHeadUser {
...
public struct WebhookPullRequestReviewRequestedVariant0PullRequestLabelsItem: Codable {
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestLabelsItem {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public struct WebhookPullRequestReviewRequestedVariant0PullRequestMergedBy: Codable {
    public var id: Int
    ...
    public var type: WebhookPullRequestReviewRequestedVariant0PullRequestMergedByType?
    public var url: String?
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMergedBy {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMergedBy {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestReviewRequestedVariant0PullRequestMergedByType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestReviewRequestedVariant0PullRequestMergedBy {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestReviewRequestedVariant0PullRequestMilestone: Codable {
    public var closedAt: Date?
    public var closedIssues: Int
    public var createdAt: Date
    /// User
    public var creator: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneCreator?
    public var description: String?
    ...
    public var state: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneState
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMilestone {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestMilestone {
    public init(closedAt: Date?, closedIssues: Int, createdAt: Date, creator: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneCreator?, description: String?, dueOn: Date?, htmlUrl: String, id: Int, labelsUrl: String, nodeId: String, number: Int, openIssues: Int, state: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneState, title: String, updatedAt: Date, url: String) throws {
...
extension WebhookPullRequestReviewRequestedVariant0PullRequestMilestone {
    func sdkValidateConstraints() throws {
...
public struct WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneCreator: Codable {
    public var id: Int
    public var login: String
    public var avatarUrl: String?
    public var deleted: Bool?
    ...
    public var starredUrl: String?
    public var subscriptionsUrl: String?
    public var type: WebhookPullRequestReviewRequestedVariant0PullRequestMilestoneCreatorType?
    public var url: String?
    public var userViewType: String?
