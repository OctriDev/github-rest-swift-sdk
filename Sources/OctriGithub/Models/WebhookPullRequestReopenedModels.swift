...
// WebhookPullRequestReopened domain models
/// Typed representation of the `WebhookPullRequestReopened` API schema.
public struct WebhookPullRequestReopened: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookPullRequestReopenedAction
...
public extension WebhookPullRequestReopened {
...
public extension WebhookPullRequestReopened {
    public init(action: WebhookPullRequestReopenedAction, number: WebhooksNumber, pullRequest: PullRequestWebhook, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookPullRequestReopenedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let reopened = WebhookPullRequestReopenedAction(rawValue: "reopened")
