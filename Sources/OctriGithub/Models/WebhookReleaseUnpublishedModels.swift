...
// WebhookReleaseUnpublished domain models
/// Typed representation of the `WebhookReleaseUnpublished` API schema.
public struct WebhookReleaseUnpublished: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookReleaseUnpublishedAction
    /// The release object.
...
public extension WebhookReleaseUnpublished {
...
public extension WebhookReleaseUnpublished {
    public init(action: WebhookReleaseUnpublishedAction, release: WebhooksRelease1, repository: RepositoryWebhooks, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, sender: SimpleUser? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookReleaseUnpublishedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let unpublished = WebhookReleaseUnpublishedAction(rawValue: "unpublished")
