...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseRepoLicense {
...
public struct WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseRepoOwner: Codable {
    public var id: Int
    ...
    public var type: WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX39989e2594?
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseRepoOwner {
...
public struct WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX7b5f9c17c9: Codable {
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX7b5f9c17c9 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX188e616e10 {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX188e616e10: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX188e616e10")
    }
...
public struct WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUser: Codable {
    public var id: Int
    public var login: String
    public var avatarUrl: String?
    public var deleted: Bool?
    ...
    public var starredUrl: String?
    public var subscriptionsUrl: String?
    public var type: WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUserType?
    public var url: String?
    public var userViewType: String?
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUser {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUserType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseUser {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestReviewRequestRemovedVariant1PullRequestHead: Codable {
    public var label: String
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo
    public var sha: String
    /// User
    public var user: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser?
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo, sha: String, user: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser?) {
