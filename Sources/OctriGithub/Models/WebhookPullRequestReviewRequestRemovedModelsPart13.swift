...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseRepoLicense {
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestBaseX7b5f9c17c9 {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestReviewRequestRemovedVariant1PullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
