...
public struct WebhookPullRequestUnlockedPullRequestBaseRepoPermissions: Codable {
...
public extension WebhookPullRequestUnlockedPullRequestBaseRepoPermissions {
...
public enum WebhookPullRequestUnlockedPullRequestBaseRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestUnlockedPullRequestBaseRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestUnlockedPullRequestBaseRepoPushedAt")
    }
...
public struct WebhookPullRequestUnlockedPullRequestBaseUser: Codable {
    ...
    public var type: WebhookPullRequestUnlockedPullRequestBaseUserType?
...
public extension WebhookPullRequestUnlockedPullRequestBaseUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestUnlockedPullRequestBaseUser {
...
public struct WebhookPullRequestUnlockedPullRequestHead: Codable {
    /// Required `string` value serialized in the `label` wire field.
    public var label: String
    /// Required `string` value serialized in the `ref` wire field.
    public var ref: String
    /// A git repository
    public var repo: WebhookPullRequestUnlockedPullRequestHeadRepo?
    /// Required `string` value serialized in the `sha` wire field.
    public var sha: String
    /// Required object value serialized in the `user` wire field.
    public var user: WebhookPullRequestUnlockedPullRequestHeadUser?
...
public extension WebhookPullRequestUnlockedPullRequestHead {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestUnlockedPullRequestHead {
    public init(label: String, ref: String, repo: WebhookPullRequestUnlockedPullRequestHeadRepo?, sha: String, user: WebhookPullRequestUnlockedPullRequestHeadUser?) {
