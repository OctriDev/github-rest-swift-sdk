...
// WebhookDiscussionUnlocked domain models
/// Typed representation of the `WebhookDiscussionUnlocked` API schema.
public struct WebhookDiscussionUnlocked: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDiscussionUnlockedAction
...
public extension WebhookDiscussionUnlocked {
...
public extension WebhookDiscussionUnlocked {
    public init(action: WebhookDiscussionUnlockedAction, discussion: Discussion, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDiscussionUnlockedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let unlocked = WebhookDiscussionUnlockedAction(rawValue: "unlocked")
