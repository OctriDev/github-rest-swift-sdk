...
// WebhookProjectsV2ProjectCreated domain models
/// A project was created
public struct WebhookProjectsV2ProjectCreated: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookProjectsV2ProjectCreatedAction
...
public extension WebhookProjectsV2ProjectCreated {
...
public extension WebhookProjectsV2ProjectCreated {
    public init(action: WebhookProjectsV2ProjectCreatedAction, organization: OrganizationSimpleWebhooks, projectsV2: ProjectsV2, sender: SimpleUser, installation: SimpleInstallation? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookProjectsV2ProjectCreatedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let created = WebhookProjectsV2ProjectCreatedAction(rawValue: "created")
