...
// WebhookDependabotAlertDismissed domain models
/// Typed representation of the `WebhookDependabotAlertDismissed` API schema.
public struct WebhookDependabotAlertDismissed: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookDependabotAlertDismissedAction
    /// A Dependabot alert.
...
public extension WebhookDependabotAlertDismissed {
...
public extension WebhookDependabotAlertDismissed {
    public init(action: WebhookDependabotAlertDismissedAction, alert: DependabotAlert, repository: RepositoryWebhooks, sender: SimpleUser, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil, enterprise: EnterpriseWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookDependabotAlertDismissedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let dismissed = WebhookDependabotAlertDismissedAction(rawValue: "dismissed")
