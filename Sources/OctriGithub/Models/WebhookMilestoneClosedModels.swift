...
// WebhookMilestoneClosed domain models
/// Typed representation of the `WebhookMilestoneClosed` API schema.
public struct WebhookMilestoneClosed: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookMilestoneClosedAction
...
public extension WebhookMilestoneClosed {
...
public extension WebhookMilestoneClosed {
    public init(action: WebhookMilestoneClosedAction, milestone: WebhooksMilestone, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookMilestoneClosedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let closed = WebhookMilestoneClosedAction(rawValue: "closed")
