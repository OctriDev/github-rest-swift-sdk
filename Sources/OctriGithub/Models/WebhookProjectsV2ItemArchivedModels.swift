...
// WebhookProjectsV2ItemArchived domain models
/// Typed representation of the `WebhookProjectsV2ItemArchived` API schema.
public struct WebhookProjectsV2ItemArchived: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookProjectsV2ItemArchivedAction
...
public extension WebhookProjectsV2ItemArchived {
...
public extension WebhookProjectsV2ItemArchived {
    public init(action: WebhookProjectsV2ItemArchivedAction, changes: WebhooksProjectChanges, organization: OrganizationSimpleWebhooks, projectsV2Item: ProjectsV2Item, sender: SimpleUser, installation: SimpleInstallation? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookProjectsV2ItemArchivedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let archived = WebhookProjectsV2ItemArchivedAction(rawValue: "archived")
