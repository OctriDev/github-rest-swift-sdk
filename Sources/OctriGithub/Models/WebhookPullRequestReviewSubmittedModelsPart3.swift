...
public extension WebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledByType? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewSubmittedPullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewSubmittedPullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewSubmittedPullRequestBaseUser?
    ) {
