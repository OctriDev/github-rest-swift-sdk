...
public extension WebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledBy {
...
extension WebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledBy {
...
public extension WebhookPullRequestReviewSubmittedPullRequestBase {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookPullRequestReviewSubmittedPullRequestBase {
    public init(label: String, ref: String, repo: WebhookPullRequestReviewSubmittedPullRequestBaseRepo, sha: String, user: WebhookPullRequestReviewSubmittedPullRequestBaseUser?) {
...
/// A git repository
public struct WebhookPullRequestReviewSubmittedPullRequestBaseRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestReviewSubmittedPullRequestBaseRepoCreatedAt
    ...
    public var license: WebhookPullRequestReviewSubmittedPullRequestBaseRepoLicense?
    ...
    public var owner: WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestReviewSubmittedPullRequestBaseRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestReviewSubmittedPullRequestBaseRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestReviewSubmittedPullRequestBaseRepoPullRequeX1e76836f35?
    ...
    public var mergeCommitMessage: WebhookPullRequestReviewSubmittedPullRequestBaseRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestReviewSubmittedPullRequestBaseRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestReviewSubmittedPullRequestBaseRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestReviewSubmittedPullRequestBaseRepoSquashMerX1c2eba2f63?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestReviewSubmittedPullRequestBaseRepoSquashMerXef94ed5f84?
...
public extension WebhookPullRequestReviewSubmittedPullRequestBaseRepo {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
