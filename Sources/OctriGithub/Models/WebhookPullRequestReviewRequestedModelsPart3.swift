...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestAutoMergeEnabledBy {
    init(
        ...
        type: WebhookPullRequestReviewRequestedVariant0PullRequestAutoMergeX0f8aafc5d3? = nil,
        url: String? = nil,
...
public extension WebhookPullRequestReviewRequestedVariant0PullRequestBase {
    init(
        label: String,
        ref: String,
        repo: WebhookPullRequestReviewRequestedVariant0PullRequestBaseRepo,
        sha: String,
        user: WebhookPullRequestReviewRequestedVariant0PullRequestBaseUser?
    ) {
