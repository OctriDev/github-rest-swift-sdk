...
extension WebhookDeploymentReviewRejectedWorkflowRunRepository {
    mutating func sdkSet7(_ milestonesUrl: String?, _ name: String?, _ nodeId: String?, _ notificationsUrl: String?, _ owner: WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner?) {
...
public struct WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner: Codable {
...
public extension WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner {
...
public struct WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor: Codable {
    ...
    public var type: WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType?
...
public extension WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor {
...
/// Optional enumerated value serialized in the `type` wire field.
public struct WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let bot = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType(rawValue: "Bot")
    public static let user = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType(rawValue: "User")
    public static let organization = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType(rawValue: "Organization")
...
public struct WebhookDeploymentReviewRejectedWorkflowRunConclusion: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let success = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "success")
    public static let failure = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "failure")
    public static let neutral = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "neutral")
    public static let cancelled = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "cancelled")
    public static let timedOut = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "timed_out")
    public static let actionRequired = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "action_required")
    public static let stale = WebhookDeploymentReviewRejectedWorkflowRunConclusion(rawValue: "stale")
