...
extension WebhookDeploymentReviewRejectedWorkflowRunRepository {
    mutating func sdkSet7(
        ...
        _ owner: WebhookDeploymentReviewRejectedWorkflowRunRepositoryOwner?
    ) {
...
public extension WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor {
    init(
        ...
        starredUrl: String? = nil,
        subscriptionsUrl: String? = nil,
        type: WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType? = nil,
        url: String? = nil,
        userViewType: String? = nil
    ) throws {
...
/// Optional enumerated value serialized in the `type` wire field.
public struct WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType: RawRepresentable, Hashable, Codable,
    ...
    public static let organization =
        WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType(rawValue: "Organization")
...
public struct WebhookDeploymentReviewRejectedWorkflowRunConclusion: RawRepresentable, Hashable, Codable, Sendable,
    SdkWireConvertible {
    public let rawValue: String
