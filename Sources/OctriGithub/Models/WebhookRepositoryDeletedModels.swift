...
// WebhookRepositoryDeleted domain models
/// Typed representation of the `WebhookRepositoryDeleted` API schema.
public struct WebhookRepositoryDeleted: Codable {
    /// Required enumerated value serialized in the `action` wire field.
    public var action: WebhookRepositoryDeletedAction
...
public extension WebhookRepositoryDeleted {
...
public extension WebhookRepositoryDeleted {
    public init(action: WebhookRepositoryDeletedAction, repository: RepositoryWebhooks, sender: SimpleUser, enterprise: EnterpriseWebhooks? = nil, installation: SimpleInstallation? = nil, organization: OrganizationSimpleWebhooks? = nil) {
...
/// Required enumerated value serialized in the `action` wire field.
public struct WebhookRepositoryDeletedAction: RawRepresentable, Hashable, Codable, Sendable, SdkWireConvertible {
    public let rawValue: String

    public init(rawValue: String) { self.rawValue = rawValue }
    public static let deleted = WebhookRepositoryDeletedAction(rawValue: "deleted")
