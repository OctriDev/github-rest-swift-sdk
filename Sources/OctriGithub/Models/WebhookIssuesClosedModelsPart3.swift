...
public extension WebhookIssuesClosedIssueVariant0MilestoneCreator {
...
public extension WebhookIssuesClosedIssueVariant0PerformedViaGithubApp {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public extension WebhookIssuesClosedIssueVariant0PerformedViaGithubAppOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
