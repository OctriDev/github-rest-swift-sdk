...
/// A git repository
public struct WebhookPullRequestEnqueuedPullRequestHeadRepo: Codable {
    ...
    public var createdAt: WebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAt
    ...
    public var license: WebhookPullRequestEnqueuedPullRequestHeadRepoLicense?
    ...
    public var owner: WebhookPullRequestEnqueuedPullRequestHeadRepoOwner?
    ...
    public var pushedAt: WebhookPullRequestEnqueuedPullRequestHeadRepoPushedAt?
    ...
    public var visibility: WebhookPullRequestEnqueuedPullRequestHeadRepoVisibility
    ...
    public var pullRequestCreationPolicy: WebhookPullRequestEnqueuedPullRequestHeadRepoPullRequestCreationPolicy?
    ...
    public var mergeCommitMessage: WebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitMessage?
    ...
    /// branch-name).
    public var mergeCommitTitle: WebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitTitle?
    ...
    public var permissions: WebhookPullRequestEnqueuedPullRequestHeadRepoPermissions?
    ...
    public var squashMergeCommitMessage: WebhookPullRequestEnqueuedPullRequestHeadRepoSquashMergeCommitMessage?
    ...
    public var squashMergeCommitTitle: WebhookPullRequestEnqueuedPullRequestHeadRepoSquashMergeCommitTitle?
...
public extension WebhookPullRequestEnqueuedPullRequestHeadRepo {
...
public extension WebhookPullRequestEnqueuedPullRequestHeadRepo {
    public init(archiveUrl: String, archived: Bool, assigneesUrl: String, blobsUrl: String, branchesUrl: String, cloneUrl: String, collaboratorsUrl: String, commentsUrl: String, commitsUrl: String, compareUrl: String, contentsUrl: String, contributorsUrl: String, createdAt: WebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAt, defaultBranch: String, deploymentsUrl: String, description: String?, downloadsUrl: String, eventsUrl: String, fork: Bool, forks: Int, forksCount: Int, forksUrl: String, fullName: String, gitCommitsUrl: String, gitRefsUrl: String, gitTagsUrl: String, gitUrl: String, hasDownloads: Bool, hasIssues: Bool, hasPages: Bool, hasProjects: Bool, hasWiki: Bool, hasDiscussions: Bool, homepage: String?, hooksUrl: String, htmlUrl: String, id: Int, issueCommentUrl: String, issueEventsUrl: String, issuesUrl: String, keysUrl: String, labelsUrl: String, language: String?, languagesUrl: String, license: WebhookPullRequestEnqueuedPullRequestHeadRepoLicense?, mergesUrl: String, milestonesUrl: String, mirrorUrl: String?, name: String, nodeId: String, notificationsUrl: String, openIssues: Int, openIssuesCount: Int, owner: WebhookPullRequestEnqueuedPullRequestHeadRepoOwner?, `private`: Bool, pullsUrl: String, pushedAt: WebhookPullRequestEnqueuedPullRequestHeadRepoPushedAt?, releasesUrl: String, size: Int, sshUrl: String, stargazersCount: Int, stargazersUrl: String, statusesUrl: String, subscribersUrl: String, subscriptionUrl: String, svnUrl: String, tagsUrl: String, teamsUrl: String, topics: [String], treesUrl: String, updatedAt: Date, url: String, visibility: WebhookPullRequestEnqueuedPullRequestHeadRepoVisibility, watchers: Int, watchersCount: Int, allowAutoMerge: Bool? = nil, allowForking: Bool? = nil, allowMergeCommit: Bool? = nil, allowRebaseMerge: Bool? = nil, allowSquashMerge: Bool? = nil, allowUpdateBranch: Bool? = nil, deleteBranchOnMerge: Bool? = nil, disabled: Bool? = nil, hasPullRequests: Bool? = nil, pullRequestCreationPolicy: WebhookPullRequestEnqueuedPullRequestHeadRepoPullRequestCreationPolicy? = nil, isTemplate: Bool? = nil, primaryBranch: String? = nil, mergeCommitMessage: WebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitMessage? = nil, mergeCommitTitle: WebhookPullRequestEnqueuedPullRequestHeadRepoMergeCommitTitle? = nil, organization: String? = nil, permissions: WebhookPullRequestEnqueuedPullRequestHeadRepoPermissions? = nil, `public`: Bool? = nil, roleName: String? = nil, squashMergeCommitMessage: WebhookPullRequestEnqueuedPullRequestHeadRepoSquashMergeCommitMessage? = nil, squashMergeCommitTitle: WebhookPullRequestEnqueuedPullRequestHeadRepoSquashMergeCommitTitle? = nil, stargazers: Int? = nil, useSquashPrTitleAsDefault: Bool? = nil, webCommitSignoffRequired: Bool? = nil) throws {
...
extension WebhookPullRequestEnqueuedPullRequestHeadRepo {
...
public enum WebhookPullRequestEnqueuedPullRequestHeadRepoCreatedAt {
    case intValue(Int)
    case date(Date)
}
