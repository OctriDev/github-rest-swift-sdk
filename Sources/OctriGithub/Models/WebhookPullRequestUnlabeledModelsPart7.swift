...
extension WebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestUnlabeledPullRequestHeadRepoCreatedAt")
    }
...
public struct WebhookPullRequestUnlabeledPullRequestHeadRepoLicense: Codable {
...
public extension WebhookPullRequestUnlabeledPullRequestHeadRepoLicense {
    public init(from decoder: Decoder) throws {
...
public struct WebhookPullRequestUnlabeledPullRequestHeadRepoOwner: Codable {
    ...
    public var type: WebhookPullRequestUnlabeledPullRequestHeadRepoOwnerType?
...
public extension WebhookPullRequestUnlabeledPullRequestHeadRepoOwner {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
extension WebhookPullRequestUnlabeledPullRequestHeadRepoOwner {
...
public struct WebhookPullRequestUnlabeledPullRequestHeadRepoPermissions: Codable {
...
public extension WebhookPullRequestUnlabeledPullRequestHeadRepoPermissions {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
...
public enum WebhookPullRequestUnlabeledPullRequestHeadRepoPushedAt {
    case intValue(Int)
    case date(Date)
}

extension WebhookPullRequestUnlabeledPullRequestHeadRepoPushedAt: Codable {

    public init(from decoder: Decoder) throws {
        let container = try decoder.singleValueContainer()
        if let value = Self.decodeGroup1(from: container) { self = value; return }
        throw DecodingError.dataCorruptedError(in: container, debugDescription: "No variant matched for WebhookPullRequestUnlabeledPullRequestHeadRepoPushedAt")
    }
...
public struct WebhookPullRequestUnlabeledPullRequestHeadUser: Codable {
    ...
    public var subscriptionsUrl: String?
    /// Optional enumerated value serialized in the `type` wire field.
    public var type: WebhookPullRequestUnlabeledPullRequestHeadUserType?
    /// Optional `uri`-formatted value serialized in the `url` wire field.
    public var url: String?
    /// Optional `string` value serialized in the `user_view_type` wire field.
    public var userViewType: String?
...
public extension WebhookPullRequestUnlabeledPullRequestHeadUser {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        guard container.contains(.id) else {
            throw SdkValidationError(field: "id", code: "required", message: "Validation failed for 'id': value is required")
...
public extension WebhookPullRequestUnlabeledPullRequestHeadUser {
    public init(id: Int, login: String, avatarUrl: String? = nil, deleted: Bool? = nil, email: String? = nil, eventsUrl: String? = nil, followersUrl: String? = nil, followingUrl: String? = nil, gistsUrl: String? = nil, gravatarId: String? = nil, htmlUrl: String? = nil, name: String? = nil, nodeId: String? = nil, organizationsUrl: String? = nil, receivedEventsUrl: String? = nil, reposUrl: String? = nil, siteAdmin: Bool? = nil, starredUrl: String? = nil, subscriptionsUrl: String? = nil, type: WebhookPullRequestUnlabeledPullRequestHeadUserType? = nil, url: String? = nil, userViewType: String? = nil) throws {
        (self.id, self.login) = (id, login)
        (self.avatarUrl, self.deleted) = (avatarUrl, deleted)
        (self.email, self.eventsUrl) = (email, eventsUrl)
        (self.followersUrl, self.followingUrl) = (followersUrl, followingUrl)
...
extension WebhookPullRequestUnlabeledPullRequestHeadUser {
    func sdkValidateConstraints() throws {
        if let value = self.avatarUrl {
            try sdkValidateUri("avatar_url", value)
        }
...
public struct WebhookPullRequestUnlabeledPullRequestLabelsItem: Codable {
