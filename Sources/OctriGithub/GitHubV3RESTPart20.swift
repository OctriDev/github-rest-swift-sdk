...
public class CampaignsNamespace {
    ...
    public func campaignsListOrg(
        ...
        try await CampaignsMethods.campaignsListOrgCampaigns(
            config: config,
            org: org,
            page: page,
            perPage: perPage,
    ...
    public func createCampaign(options: CampaignsMethods
        .CampaignsCreateCampaignOptions) async throws -> CampaignSummary {
        try await CampaignsMethods.campaignsCreateCampaign(config: config, options: options)
    }
    ...
    public func getCampaignSummary(org: String, campaignNumber: Int) async throws -> CampaignSummary {
        try await CampaignsMethods.campaignsGetCampaignSummary(config: config, org: org, campaignNumber: campaignNumber)
    }

    /// Updates a campaign in an organization. The authenticated user must be an owner or security manager for the
    /// organization to use this endpoint. OAuth app tokens and personal access tokens (classic) need the
    /// `security_events` scope to use this endpoint.
    public func updateCampaign(options: CampaignsMethods
        .CampaignsUpdateCampaignOptions) async throws -> CampaignSummary {
        try await CampaignsMethods.campaignsUpdateCampaign(config: config, options: options)
    }
    ...
    public func deleteCampaign(org: String, campaignNumber: Int) async throws -> SdkEmptyResponse {
        try await CampaignsMethods.campaignsDeleteCampaign(config: config, org: org, campaignNumber: campaignNumber)
    }
}
...
public class CodeScanningNamespace {
    ...
    public func getAiScanEnablementForOrg(org: String) async throws -> CodeScanningAiScanOrgSettings {
        try await CodeScanningMethods.codeScanningGetAiScanEnablementForOrg(config: config, org: org)
    }
    ...
    /// need `write:org`.
    public func updateAiScanEnablementForOrg(
        org: String,
        prScan: CodeScanningAiScanOrgEnablementUpdatePrScan?
    ) async throws -> CodeScanningAiScanOrgSettings {
        try await CodeScanningMethods.codeScanningUpdateAiScanEnablementForOrg(config: config, org: org, prScan: prScan)
    }
    ...
    public func listAlertsForOrg(options: CodeScanningMethods
        .CodeScanningListAlertsForOrgOptions) async throws -> [CodeScanningOrganizationAlertItems] {
        try await CodeScanningMethods.codeScanningListAlertsForOrg(config: config, options: options)
    }
    ...
    public func getAiScanEnablement(owner: String, repo: String) async throws -> CodeScanningAiScanEnablement {
        try await CodeScanningMethods.codeScanningGetAiScanEnablement(config: config, owner: owner, repo: repo)
    }
    ...
    /// repositories.
    public func updateAiScanEnablement(
        owner: String,
        repo: String,
        prScan: CodeScanningAiScanEnablementUpdatePrScan?
    ) async throws -> CodeScanningAiScanEnablement {
        try await CodeScanningMethods.codeScanningUpdateAiScanEnablement(
            config: config,
            owner: owner,
            repo: repo,
            prScan: prScan
    ...
    /// public repositories.
    public func listAlertsForRepo(options: CodeScanningMethods
        .CodeScanningListAlertsForRepoOptions) async throws -> [CodeScanningAlertItems] {
        try await CodeScanningMethods.codeScanningListAlertsForRepo(config: config, options: options)
    }
    ...
    public func getAlert(owner: String, repo: String, alertNumber: AlertNumber) async throws -> CodeScanningAlert {
        try await CodeScanningMethods.codeScanningGetAlert(
            config: config,
            owner: owner,
            repo: repo,
    ...
    public func updateAlert(options: CodeScanningMethods
        .CodeScanningUpdateAlertOptions) async throws -> CodeScanningAlert {
        try await CodeScanningMethods.codeScanningUpdateAlert(config: config, options: options)
    }
}

public extension CodeScanningNamespace {
    ...
    /// private or public repositories, or the `public_repo` scope to use this endpoint with only public repositories.
    func getAutofix(owner: String, repo: String, alertNumber: AlertNumber) async throws -> CodeScanningAutofix {
        try await CodeScanningMethods.codeScanningGetAutofix(
            config: config,
            owner: owner,
            repo: repo,
            alertNumber: alertNumber
    ...
    /// endpoint with private or public repositories, or the `public_repo` scope to use this endpoint with only public
    /// repositories.
    func createAutofix(owner: String, repo: String, alertNumber: AlertNumber) async throws -> CodeScanningAutofix {
        try await CodeScanningMethods.codeScanningCreateAutofix(
            config: config,
            owner: owner,
            repo: repo,
            alertNumber: alertNumber
    ...
    func commitAutofix(
        ...
        try await CodeScanningMethods.codeScanningCommitAutofix(
            config: config,
            owner: owner,
            repo: repo,
            alertNumber: alertNumber,
    ...
    func listAlertInstances(
        ...
        try await CodeScanningMethods.codeScanningListAlertInstances(
            config: config,
            owner: owner,
            repo: repo,
            alertNumber: alertNumber,
    ...
    func listRecentAnalyses(options: CodeScanningMethods
        .CodeScanningListRecentAnalysesOptions) async throws -> [CodeScanningAnalysis] {
        try await CodeScanningMethods.codeScanningListRecentAnalyses(config: config, options: options)
    }

    /// Gets a specified code scanning analysis for a repository. The default JSON response contains fields that
    /// describe the analysis. This includes the Git reference and commit SHA to which the analysis relates, the
    /// datetime of the analysis, the name of the code scanning tool, and the number of alerts. The `rules_count` field
    /// in the default response give the number of rules that were run in the analysis. For very old analyses this data
    /// is not available, and `0` is returned in this field. This endpoint supports the following custom media types.
    ...
    /// 2.1.0](https://docs.oasis-open.org/sarif/sarif/v2.1.0/cs01/sarif-v2.1.0-cs01.html). It also returns additional
    /// data such as the `github/alertNumber` and `github/alertUrl` properties. OAuth app tokens and personal access
    ...
    func getAnalysis(owner: String, repo: String, analysisId: Int) async throws -> CodeScanningAnalysis {
        try await CodeScanningMethods.codeScanningGetAnalysis(
            config: config,
            owner: owner,
            repo: repo,
    ...
    /// Deletes a specified code scanning analysis from a repository. You can delete one analysis at a time. To delete a
    /// series of analyses, start with the most recent analysis and work backwards. Conceptually, the process is similar
    /// to the undo function in a text editor. When you list the analyses for a repository, one or more will be
    /// identified as deletable in the response: ``` "deletable": true ``` An analysis is deletable when it's the most
    /// recent in a set of analyses. Typically, a repository will have multiple sets of analyses for each enabled code
    /// scanning tool, where a set is determined by a unique combination of analysis values: * `ref` * `tool` *
    /// `category` If you attempt to delete an analysis that is not the most recent in a set, you'll get a 400 response
    /// with the message: ``` Analysis specified is not deletable. ``` The response from a successful `DELETE` operation
    /// provides you with two alternative URLs for deleting the next analysis in the set: `next_analysis_url` and
    /// `confirm_delete_url`. Use the `next_analysis_url` URL if you want to avoid accidentally deleting the final
    /// analysis in a set. This is a useful option if you want to preserve at least one analysis for the specified tool
    /// in your repository. Use the `confirm_delete_url` URL if you are content to remove all analyses for a tool. When
    /// you delete the last analysis in a set, the value of `next_analysis_url` and `confirm_delete_url` in the 200
    /// response is `null`. As an example of the deletion process, let's imagine that you added a workflow that
    /// configured a particular code scanning tool to analyze the code in a repository. This tool has added 15 analyses:
    /// 10 on the default branch, and another 5 on a topic branch. You therefore have two separate sets of analyses for
    /// this tool. You've now decided that you want to remove all of the analyses for the tool. To do this you must make
    /// 15 separate deletion requests. To start, you must find an analysis that's identified as deletable. Each set of
    /// analyses always has…
    func deleteAnalysis(
        owner: String,
        repo: String,
    ...
    ) async throws -> CodeScanningAnalysisDeletion {
        try await CodeScanningMethods.codeScanningDeleteAnalysis(
            config: config,
            owner: owner,
            repo: repo,
            analysisId: analysisId,
    ...
    /// scope to use this endpoint with only public repositories.
    func listCodeqlDatabases(owner: String, repo: String) async throws -> [CodeScanningCodeqlDatabase] {
        try await CodeScanningMethods.codeScanningListCodeqlDatabases(config: config, owner: owner, repo: repo)
    }
}
...
public extension CodeScanningNamespace {
    ...
    /// public repositories.
    func getCodeqlDatabase(owner: String, repo: String, language: String) async throws -> CodeScanningCodeqlDatabase {
        try await CodeScanningMethods.codeScanningGetCodeqlDatabase(
            config: config,
            owner: owner,
            repo: repo,
            language: language
    ...
    /// use this endpoint with only public repositories.
    func deleteCodeqlDatabase(owner: String, repo: String, language: String) async throws -> SdkEmptyResponse {
        try await CodeScanningMethods.codeScanningDeleteCodeqlDatabase(
            config: config,
            owner: owner,
            repo: repo,
            language: language
    ...
    func createVariantAnalysis(
        ...
        try await CodeScanningMethods.codeScanningCreateVariantAnalysis(
            config: config,
            owner: owner,
            repo: repo,
            language: language,
    ...
    /// `security_events` scope to use this endpoint with private or public repositories, or the `public_repo` scope to
    /// use this endpoint with only public repositories.
    func getVariantAnalysis(
        owner: String,
        repo: String,
        codeqlVariantAnalysisId: Int
    ) async throws -> CodeScanningVariantAnalysis {
        try await CodeScanningMethods.codeScanningGetVariantAnalysis(
            config: config,
            owner: owner,
            repo: repo,
    ...
    /// tokens (classic) need the `security_events` scope to use this endpoint with private or public repositories, or
    /// the `public_repo` scope to use this endpoint with only public repositories.
    func getVariantAnalysisRepoTask(
        owner: String,
        repo: String,
        codeqlVariantAnalysisId: Int,
        repoOwner: String,
        ...
        try await CodeScanningMethods.codeScanningGetVariantAnalysisRepoTask(
            config: config,
            owner: owner,
            repo: repo,
            codeqlVariantAnalysisId: codeqlVariantAnalysisId,
    ...
    func getDefaultSetup(owner: String, repo: String) async throws -> CodeScanningDefaultSetup {
        try await CodeScanningMethods.codeScanningGetDefaultSetup(config: config, owner: owner, repo: repo)
    }
    ...
    func updateDefaultSetup(options: CodeScanningMethods
        .CodeScanningUpdateDefaultSetupOptions) async throws -> EmptyObject {
        try await CodeScanningMethods.codeScanningUpdateDefaultSetup(config: config, options: options)
    }
    ...
    /// by…
    func uploadSarif(options: CodeScanningMethods
        .CodeScanningUploadSarifOptions) async throws -> CodeScanningSarifsReceipt {
        try await CodeScanningMethods.codeScanningUploadSarif(config: config, options: options)
    }
}
...
public extension CodeScanningNamespace {
    ...
    /// endpoint with private or public repositories, or the `public_repo` scope to use this endpoint with only public
    /// repositories.
    func getSarif(owner: String, repo: String, sarifId: String) async throws -> CodeScanningSarifsStatus {
        try await CodeScanningMethods.codeScanningGetSarif(config: config, owner: owner, repo: repo, sarifId: sarifId)
    }
}
