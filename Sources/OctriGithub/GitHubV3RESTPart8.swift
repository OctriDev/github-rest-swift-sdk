...
public extension ActionsNamespace {
    ...
    func createRepoVariable(owner: String, repo: String, name: String, value: String) async throws -> EmptyObject {
        try await ActionsMethods.actionsCreateRepoVariable(
            config: config,
            owner: owner,
            repo: repo,
            name: name,
    ...
    func getRepoVariable(owner: String, repo: String, name: String) async throws -> ActionsVariable {
        try await ActionsMethods.actionsGetRepoVariable(config: config, owner: owner, repo: repo, name: name)
    }
    ...
    func updateRepoVariable(
        ...
        try await ActionsMethods.actionsUpdateRepoVariable(
            config: config,
            owner: owner,
            repo: repo,
            name: name,
    ...
    func deleteRepoVariable(owner: String, repo: String, name: String) async throws -> SdkEmptyResponse {
        try await ActionsMethods.actionsDeleteRepoVariable(config: config, owner: owner, repo: repo, name: name)
    }
    ...
    func listRepoWorkflows(
        ...
        try await ActionsMethods.actionsListRepoWorkflows(
            config: config,
            owner: owner,
            repo: repo,
            perPage: perPage,
    ...
    func getWorkflow(owner: String, repo: String, workflowId: ActionsGetWorkflowParameter) async throws -> Workflow {
        try await ActionsMethods.actionsGetWorkflow(config: config, owner: owner, repo: repo, workflowId: workflowId)
    }
    ...
    func disableWorkflow(
        owner: String,
        repo: String,
        workflowId: ActionsGetWorkflowParameter
    ) async throws -> SdkEmptyResponse {
        try await ActionsMethods.actionsDisableWorkflow(
            config: config,
            owner: owner,
            repo: repo,
    ...
    func createWorkflowDispatch(
        ...
        try await ActionsMethods.actionsCreateWorkflowDispatch(
            config: config,
            owner: owner,
            repo: repo,
            workflowId: workflowId,
...
public extension ActionsNamespace {
    ...
    func enableWorkflow(
        ...
        try await ActionsMethods.actionsEnableWorkflow(config: config, owner: owner, repo: repo, workflowId: workflowId)
    }

    /// List all workflow runs for a workflow. You can replace `workflow_id` with the workflow file name. For example,
    /// you could use `main.yaml`. You can use parameters to narrow the list of results. For more information about
    ...
    /// `head_sha`, `status`.
    func listWorkflowRuns(options: ActionsMethods
        .ActionsListWorkflowRunsOptions) async throws -> ActionsListWorkflowRunsResponse {
        try await ActionsMethods.actionsListWorkflowRuns(config: config, options: options)
    }
    ...
    func getWorkflowUsage(
        ...
        try await ActionsMethods.actionsGetWorkflowUsage(
            config: config,
            owner: owner,
            repo: repo,
            workflowId: workflowId
    ...
    /// Lists all secrets available in an environment without revealing their encrypted values. Authenticated users must
    ...
    func listEnvironmentSecrets(
        owner: String,
        repo: String,
        environmentName: String,
        perPage: Int?,
        page: Int?
    ) async throws -> ActionsListEnvironmentSecretsResponse {
        try await ActionsMethods.actionsListEnvironmentSecrets(
            config: config,
            owner: owner,
            repo: repo,
    ...
    /// this endpoint.
    func getEnvironmentPublicKey(
        owner: String,
        repo: String,
        environmentName: String
    ) async throws -> ActionsPublicKey {
        try await ActionsMethods.actionsGetEnvironmentPublicKey(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName
    ...
    /// (classic) need the `repo` scope to use this endpoint.
    func getEnvironmentSecret(
        owner: String,
        repo: String,
        environmentName: String,
        secretName: String
    ) async throws -> ActionsSecret {
        try await ActionsMethods.actionsGetEnvironmentSecret(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
    ...
    /// collaborator access to a repository to create, update, or read secrets. OAuth tokens and personal access tokens
    /// (classic) need the `repo` scope to use this endpoint.
    func createOrUpdateEnvironmentSecret(
        owner: String,
        repo: String,
        environmentName: String,
        secretName: String,
        ...
        try await ActionsMethods.actionsCreateOrUpdateEnvironmentSecret(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
    ...
    func deleteEnvironmentSecret(
        owner: String,
        repo: String,
        environmentName: String,
        secretName: String
    ) async throws -> SdkEmptyResponse {
        try await ActionsMethods.actionsDeleteEnvironmentSecret(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
...
public extension ActionsNamespace {
    ...
    func listEnvironmentVariables(
        ...
        try await ActionsMethods.actionsListEnvironmentVariables(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
    ...
    func createEnvironmentVariable(
        ...
        try await ActionsMethods.actionsCreateEnvironmentVariable(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
    ...
    func getEnvironmentVariable(
        ...
        try await ActionsMethods.actionsGetEnvironmentVariable(
            config: config,
            owner: owner,
            repo: repo,
            environmentName: environmentName,
    ...
    func updateEnvironmentVariable(
        ...
        try await ActionsMethods.actionsUpdateEnvironmentVariable(
            config: config,
            owner: owner,
            repo: repo,
            name: name,
    ...
    func deleteEnvironmentVariable(
        ...
        try await ActionsMethods.actionsDeleteEnvironmentVariable(
            config: config,
            owner: owner,
            repo: repo,
            name: name,
...
public class OidcNamespace {
    ...
    /// endpoint.
    public func oidcListCustomPropertyInclusionsForEnterprise(enterprise: String) async throws
        -> [OidcCustomPropertyInclusion] {
        try await OidcMethods.oidcListOidcCustomPropertyInclusionsForEnterprise(config: config, enterprise: enterprise)
    }
    ...
    public func oidcCreateCustomPropertyInclusionForEnterprise(
        enterprise: String,
        customPropertyName: String
    ) async throws -> OidcCustomPropertyInclusion {
        try await OidcMethods.oidcCreateOidcCustomPropertyInclusionForEnterprise(
            config: config,
    ...
    /// enterprise. OAuth app tokens and personal access tokens (classic) need the `admin:enterprise` scope to use this
    /// endpoint.
    public func oidcDeleteCustomPropertyInclusionForEnterprise(
        enterprise: String,
        customPropertyName: String
    ) async throws -> SdkEmptyResponse {
        try await OidcMethods.oidcDeleteOidcCustomPropertyInclusionForEnterprise(
            config: config,
            enterprise: enterprise,
            customPropertyName: customPropertyName
        )
    ...
    public func oidcListCustomPropertyInclusionsForOrg(org: String) async throws -> [OidcCustomPropertyInclusion] {
        try await OidcMethods.oidcListOidcCustomPropertyInclusionsForOrg(config: config, org: org)
    }
    ...
    public func oidcCreateCustomPropertyInclusionForOrg(
        org: String,
        customPropertyName: String
    ) async throws -> OidcCustomPropertyInclusion {
        try await OidcMethods.oidcCreateOidcCustomPropertyInclusionForOrg(
            config: config,
            org: org,
            customPropertyName: customPropertyName
        )
    ...
    /// endpoint.
    public func oidcDeleteCustomPropertyInclusionForOrg(
        org: String,
        customPropertyName: String
    ) async throws -> SdkEmptyResponse {
        try await OidcMethods.oidcDeleteOidcCustomPropertyInclusionForOrg(
            config: config,
            org: org,
            customPropertyName: customPropertyName
        )
    ...
    public func oidcGetCustomSubTemplateForOrg(org: String) async throws -> OidcCustomSub {
        try await OidcMethods.oidcGetOidcCustomSubTemplateForOrg(config: config, org: org)
    }
    ...
    public func oidcUpdateCustomSubTemplateForOrg(
        org: String,
        includeClaimKeys: [String]?,
        useImmutableSubject: Bool?
    ) async throws -> EmptyObject {
        try await OidcMethods.oidcUpdateOidcCustomSubTemplateForOrg(
            config: config,
            org: org,
...
public class CodeSecurityNamespace {
    ...
    public func getConfigurationsForEnterprise(
        enterprise: String,
        perPage: Int?,
        before: String?,
        after: String?
    ) async throws -> [CodeSecurityConfiguration] {
        try await CodeSecurityMethods.codeSecurityGetConfigurationsForEnterprise(
            config: config,
            enterprise: enterprise,
            perPage: perPage,
            before: before,
    ...
    public func createConfigurationForEnterprise(options: CodeSecurityMethods
        .CodeSecurityCreateConfigurationForEnterpriseOptions) async throws -> CodeSecurityConfiguration {
        try await CodeSecurityMethods.codeSecurityCreateConfigurationForEnterprise(config: config, options: options)
    }

    /// Lists the default code security configurations for an enterprise. The authenticated user must be an
    /// administrator of the enterprise in order to use this endpoint. OAuth app tokens and personal access tokens
    /// (classic) need the `read:enterprise` scope to use this endpoint.
    public func getDefaultConfigurationsForEnterprise(enterprise: String) async throws
        -> CodeSecurityDefaultConfigurations {
        try await CodeSecurityMethods.codeSecurityGetDefaultConfigurationsForEnterprise(
            config: config,
            enterprise: enterprise
        )
    }
    ...
    public func getSingleConfigurationForEnterprise(
        enterprise: String,
        configurationId: Int
    ) async throws -> CodeSecurityConfiguration {
        try await CodeSecurityMethods.codeSecurityGetSingleConfigurationForEnterprise(
            config: config,
            enterprise: enterprise,
    ...
    /// enterprise in order to use this endpoint. OAuth app tokens and personal access tokens (classic) need the
    /// `admin:enterprise` scope to use this endpoint.
    public func updateEnterpriseConfiguration(options: CodeSecurityMethods
        .CodeSecurityUpdateEnterpriseConfigurationOptions) async throws -> CodeSecurityConfiguration {
        try await CodeSecurityMethods.codeSecurityUpdateEnterpriseConfiguration(config: config, options: options)
    }
    ...
    public func deleteConfigurationForEnterprise(
        enterprise: String,
        configurationId: Int
    ) async throws -> SdkEmptyResponse {
        try await CodeSecurityMethods.codeSecurityDeleteConfigurationForEnterprise(
            config: config,
            enterprise: enterprise,
            configurationId: configurationId
        )
    ...
    public func attachEnterpriseConfiguration(
        enterprise: String,
        configurationId: Int,
        scope: CodeSecurityAttachEnterpriseConfigurationRequestBodyScope
    ) async throws -> [String: JSONValue] {
        try await CodeSecurityMethods.codeSecurityAttachEnterpriseConfiguration(
            config: config,
            enterprise: enterprise,
            configurationId: configurationId,
            scope: scope
    ...
    /// authenticated user must be an administrator for the enterprise to use this endpoint. OAuth app tokens and
    /// personal access tokens (classic) need the `admin:enterprise` scope to use this endpoint.
    public func setConfigurationAsDefaultForEnterprise(
        enterprise: String,
        configurationId: Int,
        ...
        try await CodeSecurityMethods.codeSecuritySetConfigurationAsDefaultForEnterprise(
            config: config,
            enterprise: enterprise,
            configurationId: configurationId,
